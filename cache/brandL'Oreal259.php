...
<div class="offcanvas offcanvas-start cat-offcanvas" tabindex="-1" id="offcanvasHome"
  ...
  <div class="row my-4">
    ...
    With an approach grounded in science, leading beauty brand L'Oreal demands only the most visionary products from its team. Whether you need an everyday cover-up or a slick      <hr class="d-lg-none">
    </div>
    <div class="col-12 col-lg-9">
      ...
      <div class="row row-cols-2 row-cols-sm-3 g-3">
              ...
              <div class="position-relative d-inline-block product">
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="1435" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=FaceBody&group=tanning&item=1435" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative placeholder-glow">
                      <div class="product-img position-relative pt-144 bg-dark-subtle w-100 placeholder">
                        <img class="card-img rounded-0 position-absolute top-0 lazy-image"
                          data-src='./irepository/img/attachedimage/thumbnail/tanjameh-1688802557-1541592336--336--.webp'
                          onmouseover="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1688802566-169359185--336--.webp';"
                          onmouseout="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1688802557-1541592336--336--.webp';" alt="">
                      </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        L'Oreal Revitalift Clinical Vitamin C SPF 50+ Daily Anti-UV Fluid                      </h6>
      ...
      <nav aria-label="Page navigation">
        <ul class="pagination justify-content-center mt-5">
          <li class="page-item disabled"><a class="page-link border-0 bg-white text-body-tertiary"><i class="fa-solid fa-chevron-right"></i></a></li> صفحه 1 از 1 صفحه , نمایش 1-1 از 1 نتیجه<li class="page-item disabled"><a class="page-link border-0 bg-white text-body-tertiary"><i class="fa-solid fa-chevron-right"></i></a></li>        </ul>
      </nav>
    ...
    <div class="row row-cols-md-4 row-cols-2 mt-4 lh-lg text-truncate b-animate b-dark">
          ...
          SACHAJUAN        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Jack & Jones&id=8">
          Jack & Jones        </a>
                  </div>
          ...
          Curlsmith        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=The Couture Club&id=197">
          The Couture Club        </a>
                  </div>
          ...
          Sunday Riley        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Charles & Keith&id=183">
          Charles & Keith        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=MAEGAN&id=52">
          MAEGAN        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Parisian&id=268">
          Parisian        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Dickies&id=11">
          Dickies        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Noisy May&id=174">
          Noisy May        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Too Faced Cosmetics&id=247">
          Too Faced Cosmetics        </a>
                  </div>
          ...
          Heartbreak        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Barbour International&id=219">
  ...
  <div class="container-md my-5">
    ...
    <div class="row row-cols-md-4 row-cols-2 mt-4 lh-lg text-truncate b-animate b-dark">
          ...
          Jeans        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Tank Tops&id=152">
          Tank Tops        </a>
                  </div>
