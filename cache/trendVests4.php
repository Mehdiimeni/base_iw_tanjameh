  ...
  <div class="row my-4">
    ...
    <div class="col-12 col-lg-9">
      ...
      <div class="row row-cols-2 row-cols-sm-3 g-3">
              ...
              <div class="position-relative d-inline-block product">
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="4465" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=t-shirts-vests&item=4465" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative placeholder-glow">
                      <div class="product-img position-relative pt-144 bg-dark-subtle w-100 placeholder">
                        <img class="card-img rounded-0 position-absolute top-0 lazy-image"
                          data-src='./irepository/img/attachedimage/thumbnail/tanjameh-1691452760-579336160--336--.webp'
                          onmouseover="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1691452770-1595814350--336--.webp';"
                          onmouseout="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1691452760-579336160--336--.webp';" alt="">
                      </div>
                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                      <div class="wrapper position-absolute bottom-0 w-100 bg-body">
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Bershka Rolling Stones pointelle vest in white                      </h6>
                      <h6 class="m-0 text-truncate product-detail">
                        جبلیقه                        -
                        Bershka                      </h6>
                    </div>
                    <section>
                      <h6 class="fw-semibold text-danger"><span class="product-price">
                          <h6 class="fw-semibold">۱,۲۶۶,۴۹۶ تومان</h6>                        </span></h6>
                                          </section>
                  </div>
                </a>
              </div>
              ...
              <div class="position-relative d-inline-block product">
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="3677" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=t-shirts-vests&item=3677" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative placeholder-glow">
                      <div class="product-img position-relative pt-144 bg-dark-subtle w-100 placeholder">
                        <img class="card-img rounded-0 position-absolute top-0 lazy-image"
                          data-src='./irepository/img/attachedimage/thumbnail/tanjameh-1690810552-2021330521--336--.webp'
                          onmouseover="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1690810581-1604481771--336--.webp';"
                          onmouseout="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1690810552-2021330521--336--.webp';" alt="">
                      </div>
                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                      <div class="wrapper position-absolute bottom-0 w-100 bg-body">
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        PacSun daisy chain crochet tank co-ord in white sand                      </h6>
                      <h6 class="m-0 text-truncate product-detail">
                        جبلیقه                        -
                        PACSUN                      </h6>
                    </div>
                    <section>
                      <h6 class="fw-semibold text-danger"><span class="product-price">
                          <h6 class="fw-semibold">۲,۶۰۴,۸۰۰ تومان</h6>                        </span></h6>
                                          </section>
                  </div>
                </a>
              </div>
              ...
              <div class="position-relative d-inline-block product">
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="3648" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Clothing&group=t-shirts-vests&item=3648" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative placeholder-glow">
                      <div class="product-img position-relative pt-144 bg-dark-subtle w-100 placeholder">
                        <img class="card-img rounded-0 position-absolute top-0 lazy-image"
                          data-src='./irepository/img/attachedimage/thumbnail/tanjameh-1690810151-1562334260--336--.webp'
                          onmouseover="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1690810159-1091145954--336--.webp';"
                          onmouseout="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1690810151-1562334260--336--.webp';" alt="">
                      </div>
                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                      <div class="wrapper position-absolute bottom-0 w-100 bg-body">
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        ASOS DESIGN oversized cable knit cricket tank in green & mustard tipping                      </h6>
                      <h6 class="m-0 text-truncate product-detail">
                        جبلیقه                        -
                        ASOS DESIGN                      </h6>
                    </div>
              ...
              <div class="position-relative d-inline-block product">
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="3275" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=t-shirts-vests&item=3275" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative placeholder-glow">
                      <div class="product-img position-relative pt-144 bg-dark-subtle w-100 placeholder">
                        <img class="card-img rounded-0 position-absolute top-0 lazy-image"
                          data-src='./irepository/img/attachedimage/thumbnail/tanjameh-1690352153-479410067--336--.webp'
                          onmouseover="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1690352161-320483202--336--.webp';"
                          onmouseout="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1690352153-479410067--336--.webp';" alt="">
                      </div>
                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                      <div class="wrapper position-absolute bottom-0 w-100 bg-body">
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Miss Sefridge longline soft touch rib vest top in black                      </h6>
                      <h6 class="m-0 text-truncate product-detail">
                        جبلیقه                        -
                        Miss Selfridge                      </h6>
                    </div>
                    <section>
                      <h6 class="fw-semibold text-danger"><span class="product-price">
                          <h6 class="fw-semibold">۹۸۴,۸۹۶ تومان</h6>                        </span></h6>
                                          </section>
                  </div>
                </a>
              </div>
              ...
              <div class="position-relative d-inline-block product">
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="3259" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=t-shirts-vests&item=3259" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative placeholder-glow">
                      <div class="product-img position-relative pt-144 bg-dark-subtle w-100 placeholder">
                        <img class="card-img rounded-0 position-absolute top-0 lazy-image"
                          data-src='./irepository/img/attachedimage/thumbnail/tanjameh-1690351835-1165617221--336--.webp'
                          onmouseover="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1690351843-1121218791--336--.webp';"
                          onmouseout="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1690351835-1165617221--336--.webp';" alt="">
                      </div>
                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                      <div class="wrapper position-absolute bottom-0 w-100 bg-body">
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        PacSun bumble bee square neck cropped tank top in rocky road                      </h6>
                      <h6 class="m-0 text-truncate product-detail">
                        جبلیقه                        -
                        PACSUN                      </h6>
                    </div>
              ...
              <div class="position-relative d-inline-block product">
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="3257" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=t-shirts-vests&item=3257" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative placeholder-glow">
                      <div class="product-img position-relative pt-144 bg-dark-subtle w-100 placeholder">
                        <img class="card-img rounded-0 position-absolute top-0 lazy-image"
                          data-src='./irepository/img/attachedimage/thumbnail/tanjameh-1690351794-802899246--336--.webp'
                          onmouseover="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1690351805-295406582--336--.webp';"
                          onmouseout="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1690351794-802899246--336--.webp';" alt="">
                      </div>
                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                      <div class="wrapper position-absolute bottom-0 w-100 bg-body">
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        PacSun seamless marigold notch neck cropped vest in jet black                      </h6>
                      <h6 class="m-0 text-truncate product-detail">
                        جبلیقه                        -
                        PACSUN                      </h6>
                    </div>
              ...
              <div class="position-relative d-inline-block product">
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="1868" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=t-shirts-vests&item=1868" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative placeholder-glow">
                      <div class="product-img position-relative pt-144 bg-dark-subtle w-100 placeholder">
                        <img class="card-img rounded-0 position-absolute top-0 lazy-image"
                          data-src='./irepository/img/attachedimage/thumbnail/tanjameh-1688813201-1105875962--336--.webp'
                          onmouseover="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1688813209-394735763--336--.webp';"
                          onmouseout="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1688813201-1105875962--336--.webp';" alt="">
                      </div>
                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                      <div class="wrapper position-absolute bottom-0 w-100 bg-body">
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Reclaimed Vintage unisex fishnet tank in khaki                       </h6>
                      <h6 class="m-0 text-truncate product-detail">
                        جبلیقه                        -
                    ...
                    <section>
                      <h6 class="fw-semibold text-danger"><span class="product-price">
                          <h6 class="fw-semibold">۱,۳۳۶,۸۹۶ تومان</h6>                        </span></h6>
                                          </section>
                  </div>
                </a>
              </div>
              ...
              <div class="position-relative d-inline-block product">
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="1865" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=t-shirts-vests&item=1865" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative placeholder-glow">
                      <div class="product-img position-relative pt-144 bg-dark-subtle w-100 placeholder">
                        <img class="card-img rounded-0 position-absolute top-0 lazy-image"
                          data-src='./irepository/img/attachedimage/thumbnail/tanjameh-1688813081-589817362--336--.webp'
                          onmouseover="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1688813091-614793959--336--.webp';"
                          onmouseout="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1688813081-589817362--336--.webp';" alt="">
                      </div>
                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                      <div class="wrapper position-absolute bottom-0 w-100 bg-body">
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Monki ribbed vest top in pink                      </h6>
                      <h6 class="m-0 text-truncate product-detail">
                        جبلیقه                        -
                        Monki                      </h6>
                    </div>
              ...
              <div class="position-relative d-inline-block product">
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="1445" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=tops&item=1445" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative placeholder-glow">
                      <div class="product-img position-relative pt-144 bg-dark-subtle w-100 placeholder">
                        <img class="card-img rounded-0 position-absolute top-0 lazy-image"
                          data-src='./irepository/img/attachedimage/thumbnail/tanjameh-1688802022-1536758511--336--.webp'
                          onmouseover="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1688802030-384233337--336--.webp';"
                          onmouseout="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1688802022-1536758511--336--.webp';" alt="">
                      </div>
                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                      <div class="wrapper position-absolute bottom-0 w-100 bg-body">
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Nike Running Air Dri-Fit crop tank in black                      </h6>
                      <h6 class="m-0 text-truncate product-detail">
                        جبلیقه                        -
                        Nike Running                      </h6>
                    </div>
                    <section>
                      <h6 class="fw-semibold text-danger"><span class="product-price">
                          <h6 class="fw-semibold">۲,۸۱۲,۴۸۰ تومان</h6>                        </span></h6>
                                          </section>
                  </div>
                </a>
              </div>
              ...
              <div class="position-relative d-inline-block product">
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="1371" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=t-shirts-vests&item=1371" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative placeholder-glow">
                      <div class="product-img position-relative pt-144 bg-dark-subtle w-100 placeholder">
                        <img class="card-img rounded-0 position-absolute top-0 lazy-image"
                          data-src='./irepository/img/attachedimage/thumbnail/tanjameh-1688321979-659653958--336--.webp'
                          onmouseover="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1688321987-312126713--336--.webp';"
                          onmouseout="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1688321979-659653958--336--.webp';" alt="">
                      </div>
                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                      <div class="wrapper position-absolute bottom-0 w-100 bg-body">
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        River Island scoop neck tank in black                      </h6>
                      <h6 class="m-0 text-truncate product-detail">
                        جبلیقه                        -
                        River Island                      </h6>
                    </div>
              ...
              <div class="position-relative d-inline-block product">
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="1183" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=tops&item=1183" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative placeholder-glow">
                      <div class="product-img position-relative pt-144 bg-dark-subtle w-100 placeholder">
                        <img class="card-img rounded-0 position-absolute top-0 lazy-image"
                          data-src='./irepository/img/attachedimage/thumbnail/tanjameh-1688288880-1742569605--336--.webp'
                          onmouseover="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1688288889-1604157014--336--.webp';"
                          onmouseout="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1688288880-1742569605--336--.webp';" alt="">
                      </div>
                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                      <div class="wrapper position-absolute bottom-0 w-100 bg-body">
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        ASOS 4505 Icon slightly cropped vest top                       </h6>
                      <h6 class="m-0 text-truncate product-detail">
                        جبلیقه                        -
                        ASOS 4505                      </h6>
                    </div>
              ...
              <div class="position-relative d-inline-block product">
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="1180" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=tops&item=1180" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative placeholder-glow">
                      <div class="product-img position-relative pt-144 bg-dark-subtle w-100 placeholder">
                        <img class="card-img rounded-0 position-absolute top-0 lazy-image"
                          data-src='./irepository/img/attachedimage/thumbnail/tanjameh-1688288841-1009595330--336--.webp'
                          onmouseover="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1688288849-184486827--336--.webp';"
                          onmouseout="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1688288841-1009595330--336--.webp';" alt="">
                      </div>
                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                      <div class="wrapper position-absolute bottom-0 w-100 bg-body">
              ...
              <div class="position-relative d-inline-block product">
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="916" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=t-shirts-vests&item=916" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative placeholder-glow">
                      <div class="product-img position-relative pt-144 bg-dark-subtle w-100 placeholder">
                        <img class="card-img rounded-0 position-absolute top-0 lazy-image"
                          data-src='./irepository/img/attachedimage/thumbnail/tanjameh-1688280847-428560835--336--.webp'
                          onmouseover="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1688280856-1048986577--336--.webp';"
                          onmouseout="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1688280847-428560835--336--.webp';" alt="">
                      </div>
                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                      <div class="wrapper position-absolute bottom-0 w-100 bg-body">
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Topshop premium basic slouchy v neck vest in white                      </h6>
                      <h6 class="m-0 text-truncate product-detail">
                        جبلیقه                        -
                        Topshop                      </h6>
                    </div>
                    <section>
                      <h6 class="fw-semibold text-danger"><span class="product-price">
                          <h6 class="fw-semibold">۱,۱۲۶,۴۰۰ تومان</h6>                        </span></h6>
                                          </section>
                  </div>
                </a>
              </div>
      ...
      <nav aria-label="Page navigation">
        <ul class="pagination justify-content-center mt-5">
          <li class="page-item disabled"><a class="page-link border-0 bg-white text-body-tertiary"><i class="fa-solid fa-chevron-right"></i></a></li> صفحه 1 از 2 صفحه , نمایش 1-15 از 22 نتیجه<li class="page-item"><a href="?page=2" class="page-link border-0 text-reset" ><i class="fa-solid fa-chevron-left"></i></a></li>
    <li class="page-item"><a href="?page=2" class="page-link border-0 text-reset" ><i class="fa-solid fa-chevron-left"></i></a></li>        </ul>
      </nav>
    ...
    <div class="row row-cols-md-4 row-cols-2 mt-4 lh-lg text-truncate b-animate b-dark">
          ...
          We Are We Wear        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Dermalogica&id=388">
          Dermalogica        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Apothecary 87&id=213">
          Apothecary 87        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Issey Miyake&id=235">
          Issey Miyake        </a>
                  </div>
          ...
          adidas performance        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Twisted Tailor&id=322">
          Twisted Tailor        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=ASOS Tall&id=108">
          ASOS Tall        </a>
                  </div>
          ...
          Element        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Nars&id=228">
          Nars        </a>
                  </div>
          ...
          Aveeno        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=NaaNaa&id=244">
          NaaNaa        </a>
                  </div>
  ...
  <div class="container-md my-5">
    ...
    <div class="row row-cols-md-4 row-cols-2 mt-4 lh-lg text-truncate b-animate b-dark">
          ...
          Hair Sets        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Hair Sprays&id=158">
          Hair Sprays        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?trend=Pyjama Bottoms&id=118">
          Pyjama Bottoms        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?trend=Coats&id=51">
          Coats        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?trend=Card Holders&id=88">
          Card Holders        </a>
                  </div>
          ...
          Thongs        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=After Shave Lotions&id=97">
          After Shave Lotions        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?trend=Gloves&id=98">
          Gloves        </a>
                  </div>
          ...
          Spot Treatments        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Conditioners&id=74">
          Conditioners        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?trend=Palettes&id=109">
          Palettes        </a>
                  </div>
