...
<div class="offcanvas offcanvas-start cat-offcanvas" tabindex="-1" id="offcanvasHome"
  ...
  <div class="offcanvas-body p-0 overflow-y-scroll overflow-x-hidden">
    ...
    style="background-color: #02a571;">
    <div class="container-md">
      <div class="row pt-5 ps-4 ps-md-0 position-relative placeholder-glow">
        <div class="col-12 col-md-6 py-3">
          <h3 class="fw-semibold">
            تن جامه خرید فوق العاده          </h3>
          <h4 class="mb-4">
            برای همه شکل ها و اندازه ها          </h4>
        ...
        <div class="col-12 col-md-6 card p-0 rounded-0 border-0">
          <div class="position-relative pt-48 bg-dark-subtle placeholder">
            <img class="lazy-image position-absolute top-0 w-100"
              data-src="./irepository/img/adver_banner/tanjameh-1691259298-2077772441.webp"
              alt="تن جامه خرید فوق العاده">
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="owl-center-nonloop owl-carousel">
                  ...
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    ...
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۱,۲۶۶,۴۹۶ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <a href="?gender=women&category=dresses&group=party-dresses&item=4722" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    ...
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۲,۳۲۳,۲۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="5364" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=dresses&group=party-dresses&item=5364" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        In The Style Petite exclusive ruffle trim cami maxi dress in black                      </h6>
                      <h6 class="m-0 text-truncate">
                        پیراهن                        -
                        In The Style Petite                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="4666" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=trousers-leggings&item=4666" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        BOSS Targo-D wide leg cargo trousers in dark green                      </h6>
                      <h6 class="m-0 text-truncate">
                        شلوار                        -
                        BOSS Orange                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۱۲,۶۰۱,۶۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="4962" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Accessories&group=watches&item=4962" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Sekonda Mens Bracelet Watch with Black Dial in Gold                      </h6>
                      <h6 class="m-0 text-truncate">
                        ساعت                        -
                        Sekonda                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="5031" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=tops&item=5031" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        COLLUSION Slash neck long sleeve top in ecru                       </h6>
                      <h6 class="m-0 text-truncate">
                        تی شرت                        -
                        Collusion                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۷۰۳,۲۹۶ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="4731" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=t-shirts-vests&item=4731" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Weekday Jen mock neck top with exposed seams in khaki                      </h6>
                      <h6 class="m-0 text-truncate">
                        تی شرت                        -
                        Weekday                      </h6>
                    </div>
    ...
    <div class="container-md">
      <div class="row pt-5 ps-4 ps-md-0 position-relative placeholder-glow">
        ...
        <div class="col-12 col-md-6 card p-0 rounded-0 border-0">
          <div class="position-relative pt-48 bg-dark-subtle placeholder">
            <img class="lazy-image position-absolute top-0 w-100"
              data-src="./irepository/img/adver_banner/tanjameh-1687975726-1090958869.webp"
              alt="برای تمام افراد">
          </div>
        </div>
      </div>
      ...
      <div class="col-12 col-md-11 position-relative overflow-hidden">
        ...
        <div class="owl-center-nonloop owl-carousel">
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5395" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Shoes&group=boots&item=5395" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Simmi London Rayan fold over heeled knee boots in tan patent croc                      </h6>
                      <h6 class="m-0 text-truncate">
                      چکمه                        -
                        SIMMI Shoes                      </h6>
                    </div>
                ...
                <a href="?gender=men&category=Clothing&group=polo-shirts&item=4447" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    ...
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۱,۸۳۰,۴۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4636" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Clothing&group=underwear-socks&item=4636" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        ASOS DESIGN 2 pack Pokémon sport sock with Jigglypuff design                      </h6>
                      <h6 class="m-0 text-truncate">
                      جوراب                        -
                        ASOS DESIGN                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5319" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=coats-jackets&item=5319" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Stradivarius STR faux leather cropped biker jacket in washed brown                       </h6>
                      <h6 class="m-0 text-truncate">
                      کاپشن و بارونی                        -
                        Stradivarius                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۳,۹۴۱,۶۹۶ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4942" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Clothing&group=underwear-socks&item=4942" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Boss Bodywear bold 3 pack briefs with contrast waistbands in black                      </h6>
                      <h6 class="m-0 text-truncate">
                      Briefs                        -
                        BOSS Bodywear                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۲,۷۴۵,۶۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5349" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Clothing&group=jeans&item=5349" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Guess Originals relaxed jeans in medium wash                      </h6>
                      <h6 class="m-0 text-truncate">
                      جین                        -
                        GUESS Originals                      </h6>
                    </div>
  ...
  <div class="text-dark"
    style="background-color: #8f8c82;">
    <div class="container-md">
      <div class="row pt-5 ps-4 ps-md-0 position-relative placeholder-glow">
        <div class="col-12 col-md-6 py-3">
          <h3 class="fw-semibold">
            سریعترین و بهترین خدمات          </h3>
          <h4 class="mb-4">
            یک کلمه تن جامه          </h4>
          <a href="https://new.tanjameh.com/?gender=men&category=Clothing&group=shirts&CatId=3602" class="text-decoration-none text-dark fw-semibold stretched-link">
            مشاهده کنید<i
        ...
        <div class="col-12 col-md-6 card p-0 rounded-0 border-0">
          <div class="position-relative pt-48 bg-dark-subtle placeholder">
            <img class="lazy-image position-absolute top-0 w-100"
              data-src="./irepository/img/adver_banner/tanjameh-1687976533-855623983.webp"
              alt="سریعترین و بهترین خدمات">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-12 col-md-11 position-relative overflow-hidden">
        ...
        <div class="owl-center-nonloop owl-carousel">
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4826" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Shoes%2C+Boots+%26+Trainers&group=sandals&item=4826" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                        <div class="text-bg-danger p-1 mb-2"><small>تخفیف</small></div>                      </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Dr Martens Garin sandals in back brando leather                      </h6>
                      <h6 class="m-0 text-truncate">
                      صندل                        -
                        Dr Martens                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۷,۲۸۶,۴۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5320" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=dresses&group=maxi-dresses&item=5320" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Weekday Net long sleeve maxi dress in black                      </h6>
                      <h6 class="m-0 text-truncate">
                      پیراهن                        -
                        Weekday                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۴,۱۵۳,۶۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4518" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=coats-jackets&item=4518" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Something New X Aisha Potter quilted sleeve bomber jacket in black                      </h6>
                      <h6 class="m-0 text-truncate">
                      کاپشن و بارونی                        -
                        Something New                      </h6>
                    </div>
                ...
                <a href="?gender=men&category=Clothing&group=jackets-coats&item=5135" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    ...
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۶,۱۹۱,۶۸۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5223" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Clothing&group=suits&item=5223" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                        <div class="text-bg-danger p-1 mb-2"><small>تخفیف</small></div>                      </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        ASOS DESIGN super skinny velvet blazer in gold                      </h6>
                      <h6 class="m-0 text-truncate">
                      Blazers                        -
                        ASOS DESIGN                      </h6>
                    </div>
      ...
      <div class="row pt-5 ps-4 ps-md-0 position-relative placeholder-glow">
        <div class="col-12 col-md-6 py-3">
          <h3 class="fw-semibold">
            کتونی تو نو کن          </h3>
          <h4 class="mb-4">
            کتونی های جدید ‌پاییزه          </h4>
          <a href="?gender=men&category=Shoes%2C+Boots+%26+Trainers&group=trainers&CatId=5775" class="text-decoration-none text-dark fw-semibold stretched-link">
            مشاهده بیشتر<i
              class="fa-solid fa-arrow-left"></i>
          </a>
        </div>
        <div class="col-12 col-md-6 card p-0 rounded-0 border-0">
          <div class="position-relative pt-48 bg-dark-subtle placeholder">
            <img class="lazy-image position-absolute top-0 w-100"
              data-src="./irepository/img/adver_banner/tanjameh-1691256729-1067248025.webp"
              alt="کتونی تو نو کن">
          </div>
        </div>
      </div>
      ...
      <div class="col-12 col-md-11 position-relative overflow-hidden">
        ...
        <div class="owl-center-nonloop owl-carousel">
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4594" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Shoes&group=trainers&item=4594" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Barbour International Amanza flatform leather trainers in white                      </h6>
                      <h6 class="m-0 text-truncate">
                      کفش ورزشی                        -
                        Barbour International                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۷,۶۷۳,۶۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4950" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Shoes%2C+Boots+%26+Trainers&group=sportswear&item=4950" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Nike Running Air Zoom Pegasus 40 trainers in purple                      </h6>
                      <h6 class="m-0 text-truncate">
                      کفش ورزشی                        -
                        Nike Running                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۶,۴۷۳,۹۸۴ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
  ...
  <div class="container-md my-5">
    ...
    <div class="row row-cols-md-4 row-cols-2 mt-4 lh-lg text-truncate b-animate b-dark">
                  <div class="col">
                    <a class="nav-link" href="?brand=New Look&id=64">
          New Look        </a>
                  </div>
          ...
          Commando        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Pretty Green&id=404">
          Pretty Green        </a>
                  </div>
          ...
          Erborian        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Style Cheat&id=216">
          Style Cheat        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Foreo&id=364">
          Foreo        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Elemis&id=209">
          Elemis        </a>
                  </div>
          ...
          UNIQUE21        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Bleach London&id=144">
          Bleach London        </a>
                  </div>
          ...
          Closet London        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=47 Brand&id=350">
          47 Brand        </a>
                  </div>
  ...
  <div class="container-md my-5">
    ...
    <div class="row row-cols-md-4 row-cols-2 mt-4 lh-lg text-truncate b-animate b-dark">
          ...
          Crop Tops        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Jumpers&id=117">
          Jumpers        </a>
                  </div>
          ...
          Bras        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Facial Serums&id=56">
          Facial Serums        </a>
                  </div>
          ...
          Socks        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Shorts&id=6">
          Shorts        </a>
                  </div>
          ...
          Lip Glosses        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Football Shirts&id=151">
          Football Shirts        </a>
                  </div>
