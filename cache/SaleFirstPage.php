    ...
    <div class="container-lg">
      <div class="flex-fill d-none d-lg-flex">
        <ul class="navbar-nav fw-bold">
              ...
              <a class=" nav-link  text-white" href="./?gender=sale">حراج</a>
            </li>
                  </ul>
      </div>
  ...
  <div class="container-lg">
    ...
    <div class="d-lg-block d-none">
      <ul class="navbar-nav">
              ...
              <a class="nav-link" href="./?gender=sale&category=men"
                data-bs-toggle="dropdown"> مردانه </a>
                ...
                <div class="container-lg">
                  <div class="row b-animate b-dark">
                            ...
                            <div class="d-grid cat">
                                                    <a
                          href="./?gender=sale&category=men&group=sale&CatId="><i
                    ...
                    <div class="col">
                      <div class="card bg-danger rounded-0 border-0 ps-4 mt-5" style="max-width: 18rem;">
                        ...
                        <div class="card-body">
                          <p class="card-text b-animate b-light"><a href="./?gender=sale&category=sale" class="text-white text-decoration-none ">خرید
                      ...
                      <li class="nav-item dropdown has-megamenu">
              <a class="nav-link" href="./?gender=sale&category=women"
                data-bs-toggle="dropdown"> زنانه </a>
              <div class="dropdown-menu megamenu rounded-0" role="menu">
                <div class="container-lg">
                  <div class="row b-animate b-dark">
                                              <div class="col">
                            ...
                            <div class="d-grid cat">
                                                    <a
                          href="./?gender=sale&category=women&group=sale&CatId="><i
                            class="fa-solid fa-shirt"></i>
                          حراج زنانه                        </a>
                                            <div class="col">
                    </div>
...
<div class="offcanvas offcanvas-start cat-offcanvas" tabindex="-1" id="offcanvasHome"
        ...
        <div class="col-12 col-md-6 card p-0 rounded-0 border-0">
          <div class="position-relative pt-48 bg-dark-subtle placeholder">
            <img class="lazy-image position-absolute top-0 w-100"
              data-src="./irepository/img/adver_banner/tanjameh-1690782160-1247143665.webp"
              alt="جنس اصل قیمت ارزان">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-12 col-md-11 position-relative overflow-hidden">
        ...
        <div class="owl-center-nonloop owl-carousel">
                  ...
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    ...
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۹۸۵,۶۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="5130" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=trousers-leggings&item=5130" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                        <div class="text-bg-danger p-1 mb-2"><small>تخفیف</small></div>                      </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        ASOS DESIGN wide leg pleated striped trouser in grey                      </h6>
                      <h6 class="m-0 text-truncate">
                        شلوار                        -
                        ASOS DESIGN                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="5116" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Clothing&group=hoodies-sweatshirts&item=5116" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                        <div class="text-bg-danger p-1 mb-2"><small>تخفیف</small></div>                      </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Carhartt WIP chase hoodie in orange                      </h6>
                      <h6 class="m-0 text-truncate">
                        هودی                        -
                        Carhartt WIP                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۴,۷۸۷,۲۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="5439" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Clothing&group=tracksuits&item=5439" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                        <div class="text-bg-danger p-1 mb-2"><small>تخفیف</small></div>                      </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        ASOS DESIGN heavyweight oversized sweatshirt in black                      </h6>
                      <h6 class="m-0 text-truncate">
                        سویی شرت                        -
                        ASOS DESIGN                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۱,۵۸۴,۰۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="5198" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Clothing&group=shirts&item=5198" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                        <div class="text-bg-danger p-1 mb-2"><small>تخفیف</small></div>                      </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        GANT icon logo banker stripe regular fit oxford shirt in light blue                      </h6>
                      <h6 class="m-0 text-truncate">
                        تیشرت                        -
                        Gant                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="4685" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=dresses&group=maxi-dresses&item=4685" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                        <div class="text-bg-danger p-1 mb-2"><small>تخفیف</small></div>                      </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Monki maxi t-shirt dress in washed black                      </h6>
                      <h6 class="m-0 text-truncate">
                        پیراهن                        -
                        Monki                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="4668" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=trousers-leggings&item=4668" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                        <div class="text-bg-danger p-1 mb-2"><small>تخفیف</small></div>                      </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Pull&Bear knitted striped trouser in multi                      </h6>
                      <h6 class="m-0 text-truncate">
                        شلوار                        -
                        Pull&Bear                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۱,۸۶۵,۶۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
            ...
            <div class="col-12 col-md-11 position-relative overflow-hidden">
                ...
                <div class="owl-center-nonloop owl-carousel">
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5376" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Clothing&group=multipacks&item=5376" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                        ...
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Pull&Bear 2 pack v-neck crop vest top in black & white                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                کراپ تاپ                                                -
                                                Pull&Bear                                            </h6>
                                        </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5328" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Clothing&group=coats-jackets&item=5328" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                            <div class="text-bg-danger p-1 mb-2 position-absolute bottom-0 end-0"><small>تخفیف</small></div>                                        </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                ASOS DESIGN Tall faux leather shrunken moto biker jacket in black                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                کاپشن و بارونی                                                -
                                                ASOS Tall                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۱,۹۷۱,۲۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5124" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=men&category=Clothing&group=hoodies-sweatshirts&item=5124" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                            <div class="text-bg-danger p-1 mb-2 position-absolute bottom-0 end-0"><small>تخفیف</small></div>                                        </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                ASOS DESIGN heavyweight oversized sweatshirt in beige                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                سویی شرت                                                -
                                                ASOS DESIGN                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۱,۵۸۴,۰۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4656" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=men&category=Clothing&group=jumpers-cardigans&item=4656" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                            <div class="text-bg-danger p-1 mb-2 position-absolute bottom-0 end-0"><small>تخفیف</small></div>                                        </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Topman knitted pointelle jumper in stone                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                لباس بافتنی                                                -
                                                Topman                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۲,۱۴۷,۲۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5020" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Shoes&group=boots&item=5020" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                            <div class="text-bg-danger p-1 mb-2 position-absolute bottom-0 end-0"><small>تخفیف</small></div>                                        </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Puma Mayze Stack chelsea boots in black                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                چکمه                                                -
                                                Puma                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۶,۱۹۵,۲۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5134" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Clothing&group=trousers-leggings&item=5134" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                            <div class="text-bg-danger p-1 mb-2 position-absolute bottom-0 end-0"><small>تخفیف</small></div>                                        </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Vero Moda pin tuck wide leg trouser in forest green                                             </h6>
                                            <h6 class="m-0 text-truncate">
                                                شلوار                                                -
                                                Vero Moda                                            </h6>
                                        </div>
  ...
  <div class="text-dark"
    style="background-color: #bf8e73;">
    <div class="container-md">
      <div class="row pt-5 ps-4 ps-md-0 position-relative placeholder-glow">
        <div class="col-12 col-md-6 py-3">
          <h3 class="fw-semibold">
            هر روز باما باشید          </h3>
          <h4 class="mb-4">
            محصولات هر روزه          </h4>
        ...
        <div class="col-12 col-md-6 card p-0 rounded-0 border-0">
          <div class="position-relative pt-48 bg-dark-subtle placeholder">
            <img class="lazy-image position-absolute top-0 w-100"
              data-src="./irepository/img/adver_banner/tanjameh-1690782205-1089586457.webp"
              alt="هر روز باما باشید">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-12 col-md-11 position-relative overflow-hidden">
        ...
        <div class="owl-center-nonloop owl-carousel">
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5024" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Shoes&group=boots&item=5024" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                        <div class="text-bg-danger p-1 mb-2"><small>تخفیف</small></div>                      </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Barbour Mallow wellington boots in pastel pink                      </h6>
                      <h6 class="m-0 text-truncate">
                      چکمه                        -
                        Barbour                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۳,۰۹۷,۶۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4635" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=skirts&item=4635" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                        <div class="text-bg-danger p-1 mb-2"><small>تخفیف</small></div>                      </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        ASOS DESIGN Petite satin bias maxi skirt in black                       </h6>
                      <h6 class="m-0 text-truncate">
                      دامن                        -
                        ASOS Petite                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4590" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Accessories&group=hair-accessories&item=4590" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                        <div class="text-bg-danger p-1 mb-2"><small>تخفیف</small></div>                      </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        & Other Stories faux pearl hair claw clip in gold                      </h6>
                      <h6 class="m-0 text-truncate">
                      Hair Clips                        -
                        & Other Stories                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4658" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Clothing&group=jumpers-cardigans&item=4658" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                        <div class="text-bg-danger p-1 mb-2"><small>تخفیف</small></div>                      </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Topman fluffy knitted cardigan in olive                      </h6>
                      <h6 class="m-0 text-truncate">
                      ژاکت کش بافت                        -
                        Topman                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4985" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Shoes%2C+Boots+%26+Trainers&group=sportswear&item=4985" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                        <div class="text-bg-danger p-1 mb-2"><small>تخفیف</small></div>                      </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Nike Training Legend Essential 3 NN trainers in grey                      </h6>
                      <h6 class="m-0 text-truncate">
                      کفش ورزشی                        -
                        Nike Training                      </h6>
                    </div>
            ...
            <div class="col-12 col-md-11 position-relative overflow-hidden">
                ...
                <div class="owl-center-nonloop owl-carousel">
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5329" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=men&category=Shoes%2C+Boots+%26+Trainers&group=boots&item=5329" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                            <div class="text-bg-danger p-1 mb-2 position-absolute bottom-0 end-0"><small>تخفیف</small></div>                                        </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Clarks Originals Wallabee Cup sole boots in maple suede                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                چکمه                                                -
                                                Clarks Originals                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۷,۸۸۴,۸۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4899" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Clothing&group=coats-jackets&item=4899" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                            <div class="text-bg-danger p-1 mb-2 position-absolute bottom-0 end-0"><small>تخفیف</small></div>                                        </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Only faux leather motor jacket co-ord in black and blue                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                کاپشن و بارونی                                                -
                                                Only                                            </h6>
                                        </div>
                                ...
                                <a href="?gender=women&category=Shoes&group=boots&item=5016" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        ...
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۷,۳۲۱,۶۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4932" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Clothing&group=coats-jackets&item=4932" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                            <div class="text-bg-danger p-1 mb-2 position-absolute bottom-0 end-0"><small>تخفیف</small></div>                                        </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Topshop nero collar nylon bomber jacket in khaki                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                کاپشن و بارونی                                                -
                                                Topshop                                            </h6>
                                        </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5105" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=FaceBody&group=wellness&item=5105" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                            <div class="text-bg-danger p-1 mb-2 position-absolute bottom-0 end-0"><small>تخفیف</small></div>                                        </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Aveeno Daily Moisturising Body Wash 500ml                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                شوینده بدن                                                -
                                                Aveeno                                            </h6>
                                        </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5273" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=men&category=Clothing&group=jumpers-cardigans&item=5273" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                            <div class="text-bg-danger p-1 mb-2 position-absolute bottom-0 end-0"><small>تخفیف</small></div>                                        </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Polo Ralph Lauren icon logo pima cotton knit jumper slim fit in andover heather                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                لباس بافتنی                                                -
                                        ...
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۹,۵۳۹,۲۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
  ...
  <div class="container-md my-5">
    ...
    <div class="row row-cols-md-4 row-cols-2 mt-4 lh-lg text-truncate b-animate b-dark">
          ...
          Beauty Extras        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Face Halo&id=363">
          Face Halo        </a>
                  </div>
          ...
          Object Tall        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Never Fully Dressed&id=312">
          Never Fully Dressed        </a>
                  </div>
          ...
          Malin + Goetz        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Sunday Riley&id=250">
          Sunday Riley        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=HUGO BOSS Fragrances&id=51">
          HUGO BOSS Fragrances        </a>
                  </div>
          ...
          Topman        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Never Fully Dressed Plus&id=335">
          Never Fully Dressed Plus        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Columbia&id=172">
          Columbia        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Good For Nothing&id=264">
          Good For Nothing        </a>
                  </div>
          ...
          Billabong        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=River Island Petite&id=233">
          River Island Petite        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Origins&id=252">
          Origins        </a>
                  </div>
  ...
  <div class="container-md my-5">
    ...
    <div class="row row-cols-md-4 row-cols-2 mt-4 lh-lg text-truncate b-animate b-dark">
                  <div class="col">
                    <a class="nav-link" href="?trend=Body Washes&id=24">
          Body Washes        </a>
                  </div>
          ...
          Setting Sprays        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Snoods&id=67">
          Snoods        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?trend=Beauty Tools&id=59">
          Beauty Tools        </a>
                  </div>
          ...
          Leggings        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Underwear Sets&id=184">
          Underwear Sets        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?trend=Pyjama Tops&id=136">
          Pyjama Tops        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?trend=Hair Clips&id=39">
          Hair Clips        </a>
                  </div>
          ...
          Makeup Removers        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Blouses&id=90">
          Blouses        </a>
                  </div>
          ...
          Joggers        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Corset Tops&id=81">
          Corset Tops        </a>
                  </div>
