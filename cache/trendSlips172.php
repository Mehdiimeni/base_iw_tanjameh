...
<div class="offcanvas offcanvas-start cat-offcanvas" tabindex="-1" id="offcanvasHome"
  ...
  <div class="row my-4">
    ...
    <div class="row row-cols-md-4 row-cols-2 mt-4 lh-lg text-truncate b-animate b-dark">
                  <div class="col">
                    <a class="nav-link" href="?brand=Love Moschino&id=110">
          Love Moschino        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Lapp The Brand&id=284">
          Lapp The Brand        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Brave Soul Tall&id=287">
          Brave Soul Tall        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Living Proof&id=360">
          Living Proof        </a>
                  </div>
          ...
          Skinnydip        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Public Desire Wide Fit&id=300">
          Public Desire Wide Fit        </a>
                  </div>
          ...
          Annorlunda        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Ben Sherman&id=18">
          Ben Sherman        </a>
                  </div>
