    ...
    <div class="container-md">
      <div class="row pt-5 ps-4 ps-md-0 position-relative placeholder-glow">
        <div class="col-12 col-md-6 py-3">
          ...
          <a href="?gender=men&category=Shoes%2C+Boots+%26+Trainers&group=trainers&CatId=5775"
      ...
      <div class="col-12 col-md-11 position-relative overflow-hidden">
        ...
        <div class="owl-center-nonloop owl-carousel">
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4977" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Shoes%2C+Boots+%26+Trainers&group=sportswear&item=4977" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Nike Air Huarache Runner trainers in grey and black                      </h6>
                      <h6 class="m-0 text-truncate">
                        کفش ورزشی                        -
                        Nike                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="4779" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Shoes&group=trainers&item=4779" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        adidas Originals Forum Bold stripe trainers in cream and pink                      </h6>
                      <h6 class="m-0 text-truncate">
                        کفش ورزشی                        -
                        adidas Originals                      </h6>
                    </div>
                ...
                <a href="?gender=men&category=Shoes%2C+Boots+%26+Trainers&group=sportswear&item=4436" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    ...
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۷,۰۴۰,۰۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="4699" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Shoes&group=shoes&item=4699" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        adidas Originals Superstar trainers in off white leopard                      </h6>
                      <h6 class="m-0 text-truncate">
                        کفش ورزشی                        -
                        adidas Originals                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="4969" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Shoes%2C+Boots+%26+Trainers&group=sportswear&item=4969" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Nike Running React Infinity Run 4 Flyknit trainers in black and blue                      </h6>
                      <h6 class="m-0 text-truncate">
                        کفش ورزشی                        -
                        Nike Running                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="5009" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Shoes%2C+Boots+%26+Trainers&group=trainers&item=5009" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Jordan Max Aura 5 trainers in white and gym red                       </h6>
                      <h6 class="m-0 text-truncate">
                        کفش ورزشی                        -
                        Jordan                      </h6>
                    </div>
      ...
      <div class="col-12 col-md-11 position-relative overflow-hidden">
        ...
        <div class="owl-center-nonloop owl-carousel">
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5270" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Clothing&group=shorts&item=5270" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Tommy Hilfiger harlem drawstring short in blue                      </h6>
                      <h6 class="m-0 text-truncate">
                      شرت                        -
                        Tommy Hilfiger                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5025" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=co-ords&item=5025" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        ASOS DESIGN abstract mesh maxi skirt in brown                      </h6>
                      <h6 class="m-0 text-truncate">
                      دامن                        -
                        ASOS DESIGN                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5314" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=dresses&group=maxi-dresses&item=5314" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Y.A.S Bridesmaid satin multiway halterneck maxi dress in vibrant pink                      </h6>
                      <h6 class="m-0 text-truncate">
                      پیراهن                        -
                        Y.A.S                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۵,۹۸۴,۰۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5367" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=dresses&group=party-dresses&item=5367" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        In The Style exclusive satin bandeau mini dress in black                      </h6>
                      <h6 class="m-0 text-truncate">
                      پیراهن                        -
                        In The Style                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4941" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=jeans&item=4941" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Guess Originals co-ord panel carpenter jeans in orange                      </h6>
                      <h6 class="m-0 text-truncate">
                      جین                        -
                        GUESS Originals                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۸,۳۰۷,۲۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
      ...
      <div class="col-12 col-md-11 position-relative overflow-hidden">
        ...
        <div class="owl-center-nonloop owl-carousel">
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4667" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=trousers-leggings&item=4667" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Free People wide leg trousers in khaki green                      </h6>
                      <h6 class="m-0 text-truncate">
                      شلوار                        -
                        Free People                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۹,۱۵۲,۰۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4934" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Clothing&group=co-ords&item=4934" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Bershka textured striped shirt co-ord in orange                      </h6>
                      <h6 class="m-0 text-truncate">
                      تیشرت                        -
                        Bershka                      </h6>
                    </div>
                ...
                <a href="?gender=men&category=Clothing&group=trousers-chinos&item=5087" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    ...
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۲,۵۳۳,۶۹۶ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4755" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=tops&item=4755" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        COLLUSION ribbed vest body in white                      </h6>
                      <h6 class="m-0 text-truncate">
                      بادی                        -
                        Collusion                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۱,۰۵۵,۲۹۶ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
      ...
      <div class="col-12 col-md-11 position-relative overflow-hidden">
        ...
        <div class="owl-center-nonloop owl-carousel">
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5032" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Shoes&group=boots&item=5032" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Glamorous pointed knee boots in black                      </h6>
                      <h6 class="m-0 text-truncate">
                      چکمه                        -
                        Glamorous                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4748" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Clothing&group=shirts&item=4748" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Topman revere dogtooth jacquard shirt in khaki                      </h6>
                      <h6 class="m-0 text-truncate">
                      تیشرت                        -
                        Topman                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۲,۶۷۵,۲۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5156" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=trousers-leggings&item=5156" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Topshop Tall pinstripe straight leg tailored jogger in grey                       </h6>
                      <h6 class="m-0 text-truncate">
                      شلوار                        -
                        Topshop Tall                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۳,۲۳۸,۴۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <a href="?gender=men&category=Shoes%2C+Boots+%26+Trainers&group=boots&item=5329" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    ...
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۷,۸۸۴,۸۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <a href="?gender=women&category=Clothing&group=tops&item=4993" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    ...
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۱,۰۲۰,۸۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
