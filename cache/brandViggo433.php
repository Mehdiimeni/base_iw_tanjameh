...
<div class="offcanvas offcanvas-start cat-offcanvas" tabindex="-1" id="offcanvasHome"
  ...
  <div class="row my-4">
    ...
    Fix up and look sharp with Viggo range of standout formalwear. Taking a bolder stance on Scandi style, the brand creates a range of modern, refreshing and bright tailoring for your      <hr class="d-lg-none">
    </div>
    <div class="col-12 col-lg-9">
      ...
      <div class="row row-cols-2 row-cols-sm-3 g-3">
                    ...
                    <div class="position-relative placeholder-glow">
                      <div class="product-img position-relative pt-144 bg-dark-subtle w-100 placeholder">
                        <img class="card-img rounded-0 position-absolute top-0 lazy-image"
                          data-src='./irepository/img/attachedimage/thumbnail/tanjameh-1692005333-943172957--336--.webp'
                          onmouseover="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1692005344-1012066173--336--.webp';"
                          onmouseout="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1692005333-943172957--336--.webp';" alt="">
                      </div>
              ...
              <div class="position-relative d-inline-block product">
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="4989" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Clothing&group=shirts&item=4989" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative placeholder-glow">
                      <div class="product-img position-relative pt-144 bg-dark-subtle w-100 placeholder">
                        <img class="card-img rounded-0 position-absolute top-0 lazy-image"
                          data-src='./irepository/img/attachedimage/thumbnail/tanjameh-1692005294-402247497--336--.webp'
                          onmouseover="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1692005303-1330500538--336--.webp';"
                          onmouseout="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1692005294-402247497--336--.webp';" alt="">
                      </div>
                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Viggo checkerboard print shirt in green and pink                      </h6>
                      <h6 class="m-0 text-truncate product-detail">
                      تیشرت                        -
                        Viggo                      </h6>
                    </div>
      ...
      <nav aria-label="Page navigation">
        <ul class="pagination justify-content-center mt-5">
          <li class="page-item disabled"><a class="page-link border-0 bg-white text-body-tertiary"><i class="fa-solid fa-chevron-right"></i></a></li> صفحه 1 از 1 صفحه , نمایش 1-2 از 2 نتیجه<li class="page-item disabled"><a class="page-link border-0 bg-white text-body-tertiary"><i class="fa-solid fa-chevron-right"></i></a></li>        </ul>
      </nav>
    ...
    <div class="row row-cols-md-4 row-cols-2 mt-4 lh-lg text-truncate b-animate b-dark">
          ...
          Vesper        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Threadbare Plus Fitness&id=422">
          Threadbare Plus Fitness        </a>
                  </div>
          ...
          Schuh        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Vila Petite&id=325">
          Vila Petite        </a>
                  </div>
          ...
          Bailey Rose        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=AAPE BY A BATHING APE®&id=356">
          AAPE BY A BATHING APE®        </a>
                  </div>
          ...
          Topshop Petite        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Only Tall&id=343">
          Only Tall        </a>
                  </div>
  ...
  <div class="container-md my-5">
    ...
    <div class="row row-cols-md-4 row-cols-2 mt-4 lh-lg text-truncate b-animate b-dark">
          ...
          Skirts        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Shampoos&id=53">
          Shampoos        </a>
                  </div>
