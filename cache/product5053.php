...
<head>
  ...
  <link rel="stylesheet" href="./itemplates/iweb/static/star-rating-svg/star-rating-svg.css">
  <link rel="stylesheet" href="./itemplates/iweb/static/product-zoom/product.css">
...
<div class="offcanvas offcanvas-start cat-offcanvas" tabindex="-1" id="offcanvasHome"
        ...
        <div class="sticky-md-top">
          <div class="position-relative z-1020">
            <span class="position-absolute top-0 end-0 bg-white p-1 m-2 font-x-s">
              <div class="text-bg-danger p-1 mb-2"><small>تخفیف</small></div>            </span>
          </div>
          <ul id="glasscase" class="gc-start">
                          <li><img src="./irepository/img/attachedimage/tanjameh-1692005948-774392180.webp" alt="Nike Everyday Plus 2 pack socks in tie dye grey and khaki"></li>
                          <li><img src="./irepository/img/attachedimage/tanjameh-1692005958-1462251487.webp" alt="Nike Everyday Plus 2 pack socks in tie dye grey and khaki"></li>
                          <li><img src="./irepository/img/attachedimage/tanjameh-1692005969-931515503.webp" alt="Nike Everyday Plus 2 pack socks in tie dye grey and khaki"></li>
                          <li><img src="./irepository/img/attachedimage/tanjameh-1692005978-27688847.webp" alt="Nike Everyday Plus 2 pack socks in tie dye grey and khaki"></li>
                      </ul>
        </div>
      </div>
      <!-- details product -->
      <div class="col-12 col-md-5 offset-md-1 mt-4 mt-md-0">
        <div class="item-detail-product">
          <div class="b-animate b-dark">
            <h3>
              <a href="?brand=Nike&id=4"
                class="text-decoration-none text-dark d-block product-brand">Nike</a>
            </h3>
            <h2>
               Everyday Plus 2 pack socks in tie dye grey and khaki            </h2>
            <h3 class="fw-semibold product-title">
              ...
              <h4 class="d-inline-block me-2 text-danger prices"><span class="product-price">۹۸۵,۶۰۰</span> تومان</h4>            </h3>
                          <del class="d-block">۱,۱۹۳,۲۸۰ تومان</del>                      </div>
          <!-- rate -->
          <a href="#reviews" class="my-5 d-block text-decoration-none text-dark">
            <div class="my-rating-readOnly d-inline-block" data-rating="0"
              ...
              <nav class="cat-offcanvas">
                <div class="nav nav-pills border-bottom" id="nav-tab" role="tablist">
                  ...
                  <button class="nav-link text-black-50 rounded-0" id="nav-size2-tab" data-bs-toggle="tab"
                    ...
                    aria-selected="true">سایز کارخانه</button>
                </div>
              </nav>
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="nav-size1-pane" role="tabpanel" aria-labelledby="nav-size1"
                  ...
                  <div class="list-group list-group-flush list-size">
                                          <button type="button" value="204585462" data-lookid=""
                        data-sessionid="1s30p59veb973ooe1c7nkf1n1h"
                        data-companyid="1"
                        data-userid="" class="list-group-item list-group-item-action">
                        <div class="d-flex w-100 justify-content-between">
                          ...
                          <small class="text-muted"></small>
                                          ...
                                          <button type="button" value="204585463" data-lookid=""
                        data-sessionid="1s30p59veb973ooe1c7nkf1n1h"
                        data-companyid="1"
                        data-userid="" class="list-group-item list-group-item-action">
                        <div class="d-flex w-100 justify-content-between">
                          ...
                          <small class="text-muted"></small>
                                          ...
                                          <button type="button" value="204585459" data-lookid=""
                        data-sessionid="1s30p59veb973ooe1c7nkf1n1h"
                        data-companyid="1"
                        data-userid="" class="list-group-item list-group-item-action">
                        <div class="d-flex w-100 justify-content-between">
                        ...
                        <div class="modal-content rounded-0">
                          ...
                          <div class="modal-body px-5">
                            <h3 class="fw-semibold">
                              تمام شد                            </h3>
                            <h6>
                              اگر این کالا در انبار بازگردد، ایمیلی دریافت خواهید کرد.                            </h6>
                              ...
                              <div>
                                ...
                                <div class="input-group">
                                  ...
                                  <div class="invalid-feedback">
                                    لطفا ایمیل خود را وارد نمایید                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="resultNotify">
                              <div class="alert alert-secondary d-flex align-items-center rounded-0 border-0"
                                ...
                                <div>
                                  ما درخواست شما را دریافت کردیم، به زودی با شما در تماس خواهیم بود!                                </div>
                              </div>
          ...
          <div class="d-flex">
            ...
            <button id="btnWishlist" value="5053" type="button"
          ...
          <ul class="border border-1 rounded-0 p-0 my-4">
            ...
            <li class="border-bottom d-flex justify-content-between align-items-start py-3">
              <div class="ms-2 me-auto">
                ...
                <div class="fw-bold">
                  هزینه ارسال به دفتر لندن                </div>
                در صورت خرید حداقل مبلغ ۲,۴۶۴,۰۰۰ تومان این هزینه صفر خواهد شد              </div>
              <span class="me-2">
                ۲۴۶,۴۰۰ تومان              </span>
            </li>
            <li class="border-bottom d-flex justify-content-between align-items-start py-3">
              ...
              <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne">
                <div class="accordion-body">
                  <ul class="list-unstyled">
                    <li><strong>
                        Machine wash according to instructions on care label                      </strong> </li>
            ...
            <div class="accordion-item">
              ...
              <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo">
                <div class="accordion-body">
                  <ul class="list-unstyled">
                    <li><strong>
                        Soft, stretchy knit<br><br>Main: 100% Cotton.                      </strong> </li>
                    <li><strong><br>
                        کد محصول  :                         5053                      </strong> </li>
          ...
          <div class="hstack border border-start-0 border-end-0 p-3 mb-5">
            <div class="bg-light"><a
                href="?brand=Nike&id=4"
                class="text-decoration-none text-dark d-block product-brand">Nike</a></div>
            ...
            <div class="col-12 col-md-11 position-relative overflow-hidden">
                ...
                <div class="owl-center-nonloop owl-carousel">
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5029" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Clothing&group=co-ords&item=5029" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">
                                            
                                        </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                ASOS DESIGN abstract mesh cut out slash neck bodysuit                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                بادی                                                -
                                                ASOS DESIGN                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۱,۵۴۸,۸۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4675" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=men&category=Clothing&group=underwear-socks&item=4675" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">
                                        ...
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Champion crew socks in black peach purple 3 pack                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                جوراب                                                -
                                                Champion                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۶۳۳,۶۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4713" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=men&category=Clothing&group=multipacks&item=4713" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">
                                            <div class="text-bg-danger p-1 mb-2 position-absolute bottom-0 end-0"><small>تخفیف</small></div>
                                        </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                ASOS DESIGN 3 pack waterproof stainless steel hoop earrings set with cross pendant in silver gold and matte black                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                گوشواره                                                -
                                                ASOS DESIGN                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۱,۲۶۷,۲۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5382" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Clothing&group=multipacks&item=5382" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">
                                        ...
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Daisy Street Plus 2 pack bandeau crop top in blue ditsy and stone                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                کراپ تاپ                                                -
                                                Daisy Street Plus                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۱,۱۲۶,۴۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4764" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Clothing&group=socks-tights&item=4764" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">
                                        ...
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                ASOS DESIGN Barbie ankle socks                                             </h6>
                                            <h6 class="m-0 text-truncate">
                                                جوراب                                                -
                                                ASOS DESIGN                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۳۸۷,۲۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4577" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Accessories&group=hair-accessories&item=4577" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">
                                            <div class="text-bg-danger p-1 mb-2 position-absolute bottom-0 end-0"><small>تخفیف</small></div>
                                        ...
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Monki pearl layered ribbon choker necklace in white and black                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                Hair Clips                                                -
                                                Monki                                            </h6>
                                        </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4804" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Clothing&group=multipacks&item=4804" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">
                                        ...
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                ASOS DESIGN 2 pack fine knit long ankle socks in multi                                             </h6>
                                            <h6 class="m-0 text-truncate">
                                                جوراب                                                -
                                                ASOS DESIGN                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۴۲۲,۴۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5269" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=men&category=Clothing&group=jumpers-cardigans&item=5269" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">
                                        ...
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                ASOS DESIGN relaxed knitted soft touch stripe jumper                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                لباس بافتنی                                                -
                                                ASOS DESIGN                                            </h6>
                                        </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5053" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Accessories&group=socks-tights&item=5053" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">
                                            <div class="text-bg-danger p-1 mb-2 position-absolute bottom-0 end-0"><small>تخفیف</small></div>
                                        ...
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Nike Everyday Plus 2 pack socks in tie dye grey and khaki                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                جوراب                                                -
                                                Nike                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۹۸۵,۶۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4575" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Clothing&group=multipacks&item=4575" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">
                                        ...
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Girls Crew 18k gold plated fruit basket stud set                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                گوشواره                                                -
                                                Girls Crew                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۳,۶۶۰,۸۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
            ...
            <div class="col-12 col-md-11 position-relative overflow-hidden">
                ...
                <div class="owl-center-nonloop owl-carousel">
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5057" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Accessories&group=socks-tights&item=5057" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                        ...
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                adidas Originals 3 pack solid socks in white                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                جوراب                                                -
                                                adidas Originals                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۷۳۹,۲۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5059" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Accessories&group=socks-tights&item=5059" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                        ...
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Salomon 3 pack of everyday unisex crew socks in white brown and grey                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                جوراب                                                -
                                                Salomon                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۹۱۵,۲۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5048" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Accessories&group=socks-tights&item=5048" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                ASOS DESIGN 2 pack pop socks                                             </h6>
                                            <h6 class="m-0 text-truncate">
                                                جوراب                                                -
                                                ASOS DESIGN                                            </h6>
                                        </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5062" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Accessories&group=socks-tights&item=5062" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                            <div class="text-bg-danger p-1 mb-2 position-absolute bottom-0 end-0"><small>تخفیف</small></div>                                        </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Nike Running Spark Cushioned Unisex ankle socks in white                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                جوراب                                                -
                                                Nike Running                                            </h6>
                                        </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5045" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Accessories&group=socks-tights&item=5045" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Vero Moda 30 denier shaping tights in black                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                جوراب شلواری                                                -
                                                Vero Moda                                            </h6>
                                        </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5060" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Accessories&group=socks-tights&item=5060" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Vero Moda glitter sock with frill edge in black                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                جوراب                                                -
                                                Vero Moda                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۲۸۱,۶۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5063" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Accessories&group=socks-tights&item=5063" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                            <div class="text-bg-danger p-1 mb-2 position-absolute bottom-0 end-0"><small>تخفیف</small></div>                                        </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                & Other Stories glitter socks with frill hem in ecru                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                جوراب                                                -
                                                & Other Stories                                            </h6>
                                        </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5251" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Accessories&group=socks-tights&item=5251" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Monki 2 pack 40 denier tights in black                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                جوراب شلواری                                                -
                                                Monki                                            </h6>
                                        </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5058" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Accessories&group=socks-tights&item=5058" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                ASOS DESIGN 2 pack ballet tie up detail pop socks                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                جوراب                                                -
                                                ASOS DESIGN                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۵۶۳,۲۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5252" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Accessories&group=socks-tights&item=5252" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                adidas Originals 3 pack mid cut socks in white                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                جوراب                                                -
                                                adidas Originals                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۸۴۴,۸۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
            ...
            <div class="col-12 col-md-11 position-relative overflow-hidden">
                ...
                <div class="owl-center-nonloop owl-carousel">
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4703" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Clothing&group=lingerie-nightwear&item=4703" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                ASOS DESIGN 3 pack ribbed thongs in white                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                Briefs                                                -
                                                ASOS DESIGN                                            </h6>
                                        </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5011" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Clothing&group=tops&item=5011" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                COLLUSION slash high neck body in black                                             </h6>
                                            <h6 class="m-0 text-truncate">
                                                بادی                                                -
                                                Collusion                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۹۱۴,۴۹۶ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5422" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=FaceBody&group=tools-accessories&item=5422" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                            <div class="text-bg-danger p-1 mb-2 position-absolute bottom-0 end-0"><small>تخفیف</small></div>                                        </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Drybar The Super Lemon Drop Detangling Brush                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                برس مو                                                -
                                                Drybar                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۱,۰۲۰,۸۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4955" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=men&category=Clothing&group=polo-shirts&item=4955" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                ASOS DESIGN muscle fit Polo Shirt in khaki                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                پولو شرت                                                -
                                                ASOS DESIGN                                            </h6>
                                        </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4679" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=FaceBody&group=tools-accessories&item=4679" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Le Mini Macaron Les Essentiels! Manicure Set                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                Nail Clippers                                                -
                                                Le Mini Macaron                                            </h6>
                                        </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5215" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=men&category=FaceBody&group=makeup&item=5215" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Benefit Fan Fest Mini Mascara                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                ریمل                                                -
                                                Benefit                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۹۵۰,۴۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5424" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=FaceBody&group=hair-care&item=5424" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Drybar Detox Dry Shampoo Travel Size 40g - Original Scent                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                شامپو خشک                                                -
                                                Drybar                                            </h6>
                                        </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4993" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Clothing&group=tops&item=4993" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                            <div class="text-bg-danger p-1 mb-2 position-absolute bottom-0 end-0"><small>تخفیف</small></div>                                        </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Vero Moda seamless square neck tank top in black                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                انواع تاپ                                                -
                                                Vero Moda                                            </h6>
                                        </div>
  ...
  <div class="container-md my-5">
    <h4 class="h4 fw-semibold">
      برندهای  فروش فوق العاده    </h4>
    <div class="row row-cols-md-4 row-cols-2 mt-4 lh-lg text-truncate b-animate b-dark">
                  <div class="col">
                    <a class="nav-link" href="?brand=Frock and Frill&id=242">
          Frock and Frill        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Abercrombie & Fitch&id=10">
          Abercrombie & Fitch        </a>
                  </div>
          ...
          Estee Lauder        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=ASOS DESIGN&id=2">
          ASOS DESIGN        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Lyle & Scott&id=340">
          Lyle & Scott        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Weekday&id=38">
          Weekday        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Messy Weekend&id=353">
          Messy Weekend        </a>
                  </div>
          ...
          Loungeable        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Element&id=16">
          Element        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Collusion&id=34">
          Collusion        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Floral Street&id=352">
          Floral Street        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Erborian&id=48">
          Erborian        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Bailey Rose&id=240">
          Bailey Rose        </a>
                  </div>
          ...
          Barbour        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Milk Makeup&id=407">
          Milk Makeup        </a>
                  </div>
  ...
  <div class="container-md my-5">
    ...
    <div class="row row-cols-md-4 row-cols-2 mt-4 lh-lg text-truncate b-animate b-dark">
          ...
          Scarves        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Hair Accessories&id=144">
          Hair Accessories        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?trend=Scalp Scrubs & Treatments&id=149">
          Scalp Scrubs & Treatments        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?trend=Bracelets&id=86">
          Bracelets        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?trend=Beard Balms&id=96">
          Beard Balms        </a>
                  </div>
          ...
          Hats        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Watches&id=30">
          Watches        </a>
                  </div>
          ...
          Fleeces        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Lingerie Bralets&id=101">
          Lingerie Bralets        </a>
                  </div>
