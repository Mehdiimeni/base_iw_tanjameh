  ...
  <div class="row my-4">
    ...
    <div class="col-12 col-lg-9">
      ...
      <div class="row row-cols-2 row-cols-sm-3 g-3">
                    ...
                    <div class="position-relative placeholder-glow">
                      <div class="product-img position-relative pt-144 bg-dark-subtle w-100 placeholder">
                        <img class="card-img rounded-0 position-absolute top-0 lazy-image"
                          data-src='./irepository/img/attachedimage/thumbnail/tanjameh-1692027904-760643293--336--.webp'
                          onmouseover="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1692027913-4860941--336--.webp';"
                          onmouseout="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1692027904-760643293--336--.webp';" alt="">
                      </div>
              ...
              <div class="position-relative d-inline-block product">
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="5061" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Accessories&group=socks-tights&item=5061" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative placeholder-glow">
                      <div class="product-img position-relative pt-144 bg-dark-subtle w-100 placeholder">
                        <img class="card-img rounded-0 position-absolute top-0 lazy-image"
                          data-src='./irepository/img/attachedimage/thumbnail/tanjameh-1692006216-1674742238--336--.webp'
                          onmouseover="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1692006226-910299550--336--.webp';"
                          onmouseout="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1692006216-1674742238--336--.webp';" alt="">
                      </div>
                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                      <div class="wrapper position-absolute bottom-0 w-100 bg-body">
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Monki fishnet tights in black                      </h6>
                      <h6 class="m-0 text-truncate product-detail">
                        جوراب شلواری                        -
                        Monki                      </h6>
                    </div>
                ...
                <a href="?gender=women&category=Accessories&group=socks-tights&item=5045" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative placeholder-glow">
                      <div class="product-img position-relative pt-144 bg-dark-subtle w-100 placeholder">
                        <img class="card-img rounded-0 position-absolute top-0 lazy-image"
                          data-src='./irepository/img/attachedimage/thumbnail/tanjameh-1692005834-778615311--336--.webp'
                          onmouseover="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1692005842-1889536837--336--.webp';"
                          onmouseout="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1692005834-778615311--336--.webp';" alt="">
                      </div>
                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                      <div class="wrapper position-absolute bottom-0 w-100 bg-body">
              ...
              <div class="position-relative d-inline-block product">
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="4095" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Accessories&group=socks-tights&item=4095" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative placeholder-glow">
                      <div class="product-img position-relative pt-144 bg-dark-subtle w-100 placeholder">
                        <img class="card-img rounded-0 position-absolute top-0 lazy-image"
                          data-src='./irepository/img/attachedimage/thumbnail/tanjameh-1691392703-466887368--336--.webp'
                          onmouseover="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1691392713-1008071304--336--.webp';"
                          onmouseout="this.src='./irepository/img/attachedimage/thumbnail/tanjameh-1691392703-466887368--336--.webp';" alt="">
                      </div>
                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                      <div class="wrapper position-absolute bottom-0 w-100 bg-body">
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Pretty Polly 80d smooth opaque hold ups in black                      </h6>
                      <h6 class="m-0 text-truncate product-detail">
                        جوراب شلواری                        -
                        Pretty Polly                      </h6>
                    </div>
    ...
    <div class="row row-cols-md-4 row-cols-2 mt-4 lh-lg text-truncate b-animate b-dark">
          ...
          On Running        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=NA-KD&id=62">
          NA-KD        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Glamorous&id=123">
          Glamorous        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Bobbi Brown&id=246">
          Bobbi Brown        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Karl Kani&id=191">
          Karl Kani        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Nicce&id=42">
          Nicce        </a>
                  </div>
          ...
          Napapijri        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Skinnydip&id=107">
          Skinnydip        </a>
                  </div>
          ...
          Wrangler Plus        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Rip N Dip&id=97">
          Rip N Dip        </a>
                  </div>
  ...
  <div class="container-md my-5">
    ...
    <div class="row row-cols-md-4 row-cols-2 mt-4 lh-lg text-truncate b-animate b-dark">
          ...
          Pocket Squares        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Bodies&id=155">
          Bodies        </a>
                  </div>
