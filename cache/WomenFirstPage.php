    ...
    <div class="container-lg">
      <div class="flex-fill d-none d-lg-flex">
        <ul class="navbar-nav fw-bold">
                      <li class="nav-item">
              <a class=" nav-link nav-hover" href="./?gender=men">مردانه</a>
            </li>
                      <li class="nav-item mx-1 bg-dark">
              <a class=" nav-link  text-white" href="./?gender=women">زنانه</a>
            </li>
                      <li class="nav-item">
  ...
  <div class="container-lg">
    ...
    <div class="d-lg-block d-none">
      <ul class="navbar-nav">
              ...
              <a class="nav-link" href="./?gender=women&category=Clothing"
                ...
                <div class="container-lg">
                  <div class="row b-animate b-dark">
                            ...
                            <div class="d-grid cat">
                                                    <a
                          href="./?gender=women&category=Clothing&group=tops&CatId=4169"><i
                            class="fa-solid fa-shirt"></i>
                          تاپ                        </a>
                                                <a
                          href="./?gender=women&category=Clothing&group=coats-jackets&CatId=2641"><i
                            class="fa-solid fa-shirt"></i>
                          ژاکت - کت تک                        </a>
                                                <a
                          href="./?gender=women&category=Clothing&group=jumpers-cardigans&CatId=2637"><i
                            class="fa-solid fa-shirt"></i>
                          جامپر - ژاکت کش باف پشمی                        </a>
                                                <a
                          href="./?gender=women&category=Clothing&group=tracksuits&CatId=27953"><i
                            class="fa-solid fa-shirt"></i>
                          لباس ورزشی                        </a>
                                                <a
                          href="./?gender=women&category=Clothing&group=suits-separates&CatId=13632"><i
                            class="fa-solid fa-shirt"></i>
                          کت شلوار                        </a>
                                                <a
                          href="./?gender=women&category=Clothing&group=trousers-leggings&CatId=2640"><i
                            class="fa-solid fa-shirt"></i>
                          شلوار - ساق                        </a>
                                                <a
                          href="./?gender=women&category=Clothing&group=co-ords&CatId=19632"><i
                            class="fa-solid fa-shirt"></i>
                          لباس ست - سرهمی                        </a>
                                                <a
                          href="./?gender=women&category=Clothing&group=hoodies-sweatshirts&CatId=11321"><i
                            class="fa-solid fa-shirt"></i>
                          هودی - سویشرت                        </a>
                                                <a
                          href="./?gender=women&category=Clothing&group=jeans&CatId=3630"><i
                            class="fa-solid fa-shirt"></i>
                          جین                        </a>
                                                <a
                          href="./?gender=women&category=Clothing&group=jumpsuits-playsuits&CatId=7618"><i
                            class="fa-solid fa-shirt"></i>
                          سرهمی - فانتزی                        </a>
                                                  </div>
                        </div>
                    ...
                    <div class="col">
                      <div class="card bg-danger rounded-0 border-0 ps-4 mt-5" style="max-width: 18rem;">
                        ...
                        <div class="card-body">
                          <p class="card-text b-animate b-light"><a href="./?gender=women&category=jumpsuits-playsuits" class="text-white text-decoration-none ">خرید
                      ...
                      <li class="nav-item dropdown has-megamenu">
              <a class="nav-link" href="./?gender=women&category=Shoes"
              ...
              <div class="dropdown-menu megamenu rounded-0" role="menu">
                <div class="container-lg">
                  <div class="row b-animate b-dark">
                            ...
                            <div class="d-grid cat">
                                                    <a
                          href="./?gender=women&category=Shoes&group=trainers&CatId=6456"><i
                            class="fa-solid fa-shirt"></i>
                          کفش اسپرت                        </a>
                                                <a
                          href="./?gender=women&category=Shoes&group=boots&CatId=6455"><i
                            class="fa-solid fa-shirt"></i>
                          چکمه                        </a>
                                                <a
                          href="./?gender=women&category=Shoes&group=flat-shoes&CatId=6459"><i
                            class="fa-solid fa-shirt"></i>
                          کفش تخت                        </a>
                                                <a
                          href="./?gender=women&category=Shoes&group=heels&CatId=6461"><i
                            class="fa-solid fa-shirt"></i>
                          پاشنه بلند                        </a>
                                                <a
                          href="./?gender=women&category=Shoes&group=loafers&CatId=13692"><i
                            class="fa-solid fa-shirt"></i>
                          کفش راحتی                        </a>
                                                <a
                          href="./?gender=women&category=Shoes&group=sandals&CatId=6458"><i
                            class="fa-solid fa-shirt"></i>
                          صندل                        </a>
                                                <a
                          href="./?gender=women&category=Shoes&group=flip-flops&CatId=15173"><i
                            class="fa-solid fa-shirt"></i>
                          دمپایی                        </a>
                                                <a
                          href="./?gender=women&category=Shoes&group=slippers&CatId=6457"><i
                            class="fa-solid fa-shirt"></i>
                          راحتی                        </a>
                                                <a
                          href="./?gender=women&category=Shoes&group=shoes&CatId=27165"><i
                            class="fa-solid fa-shirt"></i>
                          کفش ورزشی                        </a>
                                                <a
                          href="./?gender=women&category=Shoes&group=wide-fit-shoes&CatId=19886"><i
                            class="fa-solid fa-shirt"></i>
                          بوت                        </a>
                                                  </div>
                        </div>
                    ...
                    <div class="col">
                      <div class="card bg-danger rounded-0 border-0 ps-4 mt-5" style="max-width: 18rem;">
                        <a href="#"><img src="./itemplates/iweb/media/owned-index.png" class="card-img-top" alt="..."></a>
                        <div class="card-body">
                          <p class="card-text b-animate b-light"><a href="./?gender=women&category=wide-fit-shoes" class="text-white text-decoration-none ">خرید
                              <i class="fa-solid fa-arrow-left"></i></a></p>
                        </div>
                      </div>
                    </div>
                      ...
                      <li class="nav-item dropdown has-megamenu">
              <a class="nav-link" href="./?gender=women&category=Accessories"
              ...
              <div class="dropdown-menu megamenu rounded-0" role="menu">
                <div class="container-lg">
                  <div class="row b-animate b-dark">
                            ...
                            <div class="d-grid cat">
                                                    <a
                          href="./?gender=women&category=Accessories&group=belts&CatId=6448"><i
                            class="fa-solid fa-shirt"></i>
                          کمربند                        </a>
                                                <a
                          href="./?gender=women&category=Accessories&group=caps&CatId=25407"><i
                            class="fa-solid fa-shirt"></i>
                          کپ                        </a>
                                                <a
                          href="./?gender=women&category=Accessories&group=gloves&CatId=11990"><i
                            class="fa-solid fa-shirt"></i>
                          دستکش                        </a>
                                                <a
                          href="./?gender=women&category=Accessories&group=hair-accessories&CatId=11412"><i
                            class="fa-solid fa-shirt"></i>
                          لوازم جانبی مو                        </a>
                                                <a
                          href="./?gender=women&category=Accessories&group=hats&CatId=6449"><i
                            class="fa-solid fa-shirt"></i>
                          کلاه زنانه                        </a>
                                                <a
                          href="./?gender=women&category=Accessories&group=scarves&CatId=6452"><i
                            class="fa-solid fa-shirt"></i>
                          شال - روسری                        </a>
                                                <a
                          href="./?gender=women&category=Accessories&group=socks-tights&CatId=7657"><i
                            class="fa-solid fa-shirt"></i>
                          جوراب - جوراب شلواری                        </a>
                                                <a
                          href="./?gender=women&category=Accessories&group=sunglasses&CatId=4545"><i
                            class="fa-solid fa-shirt"></i>
                          عینک آفتابی                        </a>
                                                <a
                          href="./?gender=women&category=Accessories&group=watches&CatId=5088"><i
                            class="fa-solid fa-shirt"></i>
                          ساعت                        </a>
                                                <a
                          href="./?gender=women&category=Accessories&group=bags-purses&CatId=8730"><i
                            class="fa-solid fa-shirt"></i>
                          کیف                        </a>
                                                  </div>
                        </div>
                    ...
                    <div class="col">
                      <div class="card bg-danger rounded-0 border-0 ps-4 mt-5" style="max-width: 18rem;">
                        <a href="#"><img src="./itemplates/iweb/media/owned-index.png" class="card-img-top" alt="..."></a>
                        <div class="card-body">
                          <p class="card-text b-animate b-light"><a href="./?gender=women&category=bags-purses" class="text-white text-decoration-none ">خرید
                              <i class="fa-solid fa-arrow-left"></i></a></p>
                        </div>
                      </div>
                    </div>
                      ...
                      <li class="nav-item dropdown has-megamenu">
              <a class="nav-link" href="./?gender=women&category=FaceBody"
              ...
              <div class="dropdown-menu megamenu rounded-0" role="menu">
                <div class="container-lg">
                  <div class="row b-animate b-dark">
                            ...
                            <div class="d-grid cat">
                                                    <a
                          href="./?gender=women&category=FaceBody&group=body-care&CatId=4896"><i
                            class="fa-solid fa-shirt"></i>
                          مراقبت از بدن                        </a>
                                                <a
                          href="./?gender=women&category=FaceBody&group=fragrances&CatId=28425"><i
                            class="fa-solid fa-shirt"></i>
                          عطر - ادکلن                        </a>
                                                <a
                          href="./?gender=women&category=FaceBody&group=hair-care&CatId=5021"><i
                            class="fa-solid fa-shirt"></i>
                          مراقبت مو                        </a>
                                                <a
                          href="./?gender=women&category=FaceBody&group=makeup&CatId=5020"><i
                            class="fa-solid fa-shirt"></i>
                          لوازم آرایش                        </a>
                                                <a
                          href="./?gender=women&category=FaceBody&group=skin-care&CatId=4540"><i
                            class="fa-solid fa-shirt"></i>
                          مراقبت پوست                        </a>
                                                <a
                          href="./?gender=women&category=FaceBody&group=tanning&CatId=5606"><i
                            class="fa-solid fa-shirt"></i>
                          برنزه                        </a>
                                                <a
                          href="./?gender=women&category=FaceBody&group=tools-accessories&CatId=16793"><i
                            class="fa-solid fa-shirt"></i>
                          ابزار - لوازم جانبی                        </a>
                                                <a
                          href="./?gender=women&category=FaceBody&group=wellness&CatId=50072"><i
                            class="fa-solid fa-shirt"></i>
                          بهداشتی                        </a>
                                                  </div>
                        </div>
                    ...
                    <div class="col">
                      <div class="card bg-danger rounded-0 border-0 ps-4 mt-5" style="max-width: 18rem;">
                        <a href="#"><img src="./itemplates/iweb/media/owned-index.png" class="card-img-top" alt="..."></a>
                        <div class="card-body">
                          <p class="card-text b-animate b-light"><a href="./?gender=women&category=wellness" class="text-white text-decoration-none ">خرید
                              <i class="fa-solid fa-arrow-left"></i></a></p>
                        </div>
                      </div>
                    </div>
                      ...
                      <li class="nav-item dropdown has-megamenu">
              <a class="nav-link" href="./?gender=women&category=dresses"
                data-bs-toggle="dropdown"> لباس زنانه </a>
              <div class="dropdown-menu megamenu rounded-0" role="menu">
                <div class="container-lg">
                  <div class="row b-animate b-dark">
                                              <div class="col">
                            ...
                            <div class="d-grid cat">
                                                    <a
                          href="./?gender=women&category=dresses&group=evening-dresses&CatId=8857"><i
                            class="fa-solid fa-shirt"></i>
                          لباس شب                        </a>
                                                <a
                          href="./?gender=women&category=dresses&group=dresses-for-weddings&CatId=13934"><i
                            class="fa-solid fa-shirt"></i>
                          لباس مهمانی                        </a>
                                                <a
                          href="./?gender=women&category=dresses&group=day-dresses&CatId=19680"><i
                            class="fa-solid fa-shirt"></i>
                          لباس روزانه                        </a>
                                                <a
                          href="./?gender=women&category=dresses&group=party-dresses&CatId=11057"><i
                            class="fa-solid fa-shirt"></i>
                          مهمانی                        </a>
                                                <a
                          href="./?gender=women&category=dresses&group=midi-dresses&CatId=12899"><i
                            class="fa-solid fa-shirt"></i>
                          لباس میدی                        </a>
                                                <a
                          href="./?gender=women&category=dresses&group=maxi-dresses&CatId=9979"><i
                            class="fa-solid fa-shirt"></i>
                          لباس ماکسی                        </a>
                                                <a
                          href="./?gender=women&category=dresses&group=mini-dresses&CatId=13597"><i
                            class="fa-solid fa-shirt"></i>
                          لباس مینی                        </a>
                                                <a
                          href="./?gender=women&category=dresses&group=bridal_dresses&CatId=8799"><i
                            class="fa-solid fa-shirt"></i>
                          لباس عروس                        </a>
                                                <a
                          href="./?gender=women&category=dresses&group=bridesmaids_dresses&CatId=8799"><i
                            class="fa-solid fa-shirt"></i>
                          لباس ساغدوش                        </a>
                                                  </div>
                        </div>
                    ...
                    <div class="col">
                      <div class="card bg-danger rounded-0 border-0 ps-4 mt-5" style="max-width: 18rem;">
                        <a href="#"><img src="./itemplates/iweb/media/owned-index.png" class="card-img-top" alt="..."></a>
                        <div class="card-body">
                          <p class="card-text b-animate b-light"><a href="./?gender=women&category=bridesmaids_dresses" class="text-white text-decoration-none ">خرید
                              <i class="fa-solid fa-arrow-left"></i></a></p>
                        </div>
                      </div>
                    </div>
                      ...
                      <li class="nav-item dropdown has-megamenu">
              <a class="nav-link" href="./?gender=women&category=look"
              ...
              <div class="dropdown-menu megamenu rounded-0" role="menu">
                <div class="container-lg">
                  <div class="row b-animate b-dark">
                            ...
                            <div class="d-grid cat">
                                                    <a
                          href="./?gender=women&category=look&group=All&CatId="><i
                            class="fa-solid fa-shirt"></i>
                          همه                        </a>
                                                <a
                          href="./?gender=women&category=look&group=Classic&CatId="><i
                            class="fa-solid fa-shirt"></i>
                          کلاسیک                        </a>
                                                <a
                          href="./?gender=women&category=look&group=Casual&CatId="><i
                            class="fa-solid fa-shirt"></i>
                          کژوال                        </a>
                                                <a
                          href="./?gender=women&category=look&group=Party&CatId="><i
                            class="fa-solid fa-shirt"></i>
                          مهمانی                        </a>
                                                <a
                          href="./?gender=women&category=look&group=Urban&CatId="><i
                            class="fa-solid fa-shirt"></i>
                          لباس خیابانی                        </a>
                                                <a
                          href="./?gender=women&category=look&group=Sport&CatId="><i
                            class="fa-solid fa-shirt"></i>
                          ورزشی                        </a>
                                                  </div>
                        </div>
                    ...
                    <div class="col">
                      <div class="card bg-danger rounded-0 border-0 ps-4 mt-5" style="max-width: 18rem;">
                        <a href="#"><img src="./itemplates/iweb/media/owned-index.png" class="card-img-top" alt="..."></a>
                        <div class="card-body">
                          <p class="card-text b-animate b-light"><a href="./?gender=women&category=Sport" class="text-white text-decoration-none ">خرید
                              <i class="fa-solid fa-arrow-left"></i></a></p>
                        </div>
                      </div>
                    </div>
...
<div class="offcanvas offcanvas-start cat-offcanvas" tabindex="-1" id="offcanvasHome"
...
</div>  <div class="text-dark"
    style="background-color: #869c8e;">
    <div class="container-md">
      <div class="row pt-5 ps-4 ps-md-0 position-relative placeholder-glow">
        <div class="col-12 col-md-6 py-3">
          <h3 class="fw-semibold">
            چند کیلیک تا ایده آل          </h3>
          <h4 class="mb-4">
            برای تو خاص تو          </h4>
          <a href="https://new.tanjameh.com/?gender=men&category=Clothing&group=shirts&CatId=3602"
        ...
        <div class="col-12 col-md-6 card p-0 rounded-0 border-0">
          <div class="position-relative pt-48 bg-dark-subtle placeholder">
            <img class="lazy-image position-absolute top-0 w-100"
              data-src="./irepository/img/adver_banner/tanjameh-1687976131-389887581.webp"
              alt="چند کیلیک تا ایده آل">
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container-fluid py-5"
      ...
      <div class="col-12 col-md-11 position-relative overflow-hidden">
        ...
        <div class="owl-center-nonloop owl-carousel">
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4630" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=skirts&item=4630" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Bershka wrap raw hem denim mini skirt in light blue                      </h6>
                      <h6 class="m-0 text-truncate">
                        دامن                        -
                        Bershka                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="5335" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Accessories&group=caps&item=5335" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        New Era 9forty NY unisex cap in teal and yellow logo                      </h6>
                      <h6 class="m-0 text-truncate">
                        کلاه                        -
                        New Era                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="4430" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=dresses&group=midi-dresses&item=4430" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Topshop premium column midi dress in mono and green floral                      </h6>
                      <h6 class="m-0 text-truncate">
                        پیراهن                        -
                        Topshop                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۵,۲۸۰,۰۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="4944" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=jeans&item=4944" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Free People jayde skinny denim flares in green                      </h6>
                      <h6 class="m-0 text-truncate">
                        جین                        -
                        Free People                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۶,۱۹۵,۲۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="4991" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=jeans&item=4991" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Weekday Arrow low waist regular fit straight leg jeans in eleven grey                      </h6>
                      <h6 class="m-0 text-truncate">
                        جین                        -
                        Weekday                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۳,۴۴۹,۶۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="4488" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=t-shirts-vests&item=4488" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Free People striped long sleeve t-shirt in blue and white                      </h6>
                      <h6 class="m-0 text-truncate">
                        تی شرت                        -
                        Free People                      </h6>
                    </div>
    ...
    <div class="container-fluid py-5">
        <div class="row">
            ...
            <div class="col-12 col-md-11 position-relative overflow-hidden">
                <h3 class="fw-semibold">
                    از جایی که ترک کردی ادامه بده                </h3>
                <div class="hstack b-animate b-dark">
                    <h4>
                        به تازگی بازدید شده                    </h4>
                    <a href="https://new.tanjameh.com/?gender=men&category=Clothing&group=shirts&CatId=3602"
                        class="ms-auto text-decoration-none text-mediumpurple">دیدن بیشتر<i
                ...
                <div class="owl-center-nonloop owl-carousel">
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5433" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=FaceBody&group=hair-care&item=5433" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Drybar High Tops Self-Grip Rollers - 6 Pack                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                اکسسوری مو                                                -
                                                Drybar                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۷۰۴,۰۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4591" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Clothing&group=jeans&item=4591" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Monki Imoo low waisted wide fit jeans in black dark washed black                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                جین                                                -
                                                Monki                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۳,۵۲۰,۰۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4753" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Clothing&group=tops&item=4753" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                COLLUSION fuzzy embroidery varsity sweat co-ord in ecru                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                کراپ تاپ                                                -
                                                Collusion                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۱,۹۰۰,۰۹۶ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4665" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Clothing&group=trousers-leggings&item=4665" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Bershka octopus cargo trousers in washed grey                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                شلوار                                                -
                                                Bershka                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۲,۸۱۶,۰۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4556" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Clothing&group=multipacks&item=4556" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Girls Crew Walk of Fame 18k gold plated stacking huggie hoop earrings                                             </h6>
                                            <h6 class="m-0 text-truncate">
                                                گوشواره                                                -
                                                Girls Crew                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۴,۲۹۴,۴۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4687" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=dresses&group=maxi-dresses&item=4687" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Stradivarius mesh maxi dress in dark floral print                                             </h6>
                                            <h6 class="m-0 text-truncate">
                                                پیراهن                                                -
                                                Stradivarius                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۲,۱۱۱,۲۹۶ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4831" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Clothing&group=skirts&item=4831" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                River Island Plus satin bias maxi skirt in black                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                دامن                                                -
                                                River Island Plus                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۲,۱۱۲,۰۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
    ...
    <div class="container-md">
      <div class="row pt-5 ps-4 ps-md-0 position-relative placeholder-glow">
        <div class="col-12 col-md-6 py-3">
          ...
          <h4 class="mb-4">
            شیک تر باش          </h4>
          <a href="https://new.tanjameh.com/?gender=men&category=Clothing&group=shirts&CatId=3602" class="text-decoration-none text-dark fw-semibold stretched-link">
            برو بخر<i
              class="fa-solid fa-arrow-left"></i>
          </a>
        </div>
        <div class="col-12 col-md-6 card p-0 rounded-0 border-0">
          <div class="position-relative pt-48 bg-dark-subtle placeholder">
            <img class="lazy-image position-absolute top-0 w-100"
              data-src="./irepository/img/adver_banner/tanjameh-1687975495-22734344.webp"
              alt="زن روز بودن">
          </div>
        </div>
      </div>
  ...
  <div class="container-fluid py-5"
      ...
      <div class="col-12 col-md-11 position-relative overflow-hidden">
        ...
        <div class="owl-center-nonloop owl-carousel">
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4642" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=skirts&item=4642" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Monki denim mini cargo skirt in blue                      </h6>
                      <h6 class="m-0 text-truncate">
                      دامن                        -
                        Monki                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5373" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=multipacks&item=5373" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        DesignB London 3 pack of chain necklaces with coin pendant in gold                      </h6>
                      <h6 class="m-0 text-truncate">
                      گردنبند                        -
                        DesignB London                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4588" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Shoes&group=flip-flops&item=4588" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        The North Face Base Camp Mini II flip flops in black                      </h6>
                      <h6 class="m-0 text-truncate">
                      دمپایی فیلیپ فلاپ                        -
                        The North Face                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5233" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=lingerie-nightwear&item=5233" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Tommy Hilfiger lounge longsleeve track top in beige                      </h6>
                      <h6 class="m-0 text-truncate">
                      تاپ خواب                        -
                        Tommy Hilfiger                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4504" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=dresses&group=mini-dresses&item=4504" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Armani Exchange logo t-shirt dress in black                      </h6>
                      <h6 class="m-0 text-truncate">
                      پیراهن                        -
                        Armani Exchange                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۵,۶۳۲,۰۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5389" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Shoes&group=boots&item=5389" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Public Desire Maria buckle heeled ankle boots in ecru                      </h6>
                      <h6 class="m-0 text-truncate">
                      چکمه                        -
                        Public Desire                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۲,۸۱۶,۰۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4470" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=t-shirts-vests&item=4470" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Bershka waffle skate t-shirt in light brown                      </h6>
                      <h6 class="m-0 text-truncate">
                      تی شرت                        -
                        Bershka                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۹۱۴,۴۹۶ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
    ...
    <div class="container-fluid py-5">
        <div class="row">
            ...
            <div class="col-12 col-md-11 position-relative overflow-hidden">
                <h3 class="fw-semibold">
                    ما فکر می کنیم اینها مورد علاقه شماست                </h3>
                <div class="hstack b-animate b-dark">
                    <h4>
                        علاقه مندی های من                    </h4>
                    <a href="https://new.tanjameh.com/?gender=men&category=Clothing&group=shirts&CatId=3602"
                        class="ms-auto text-decoration-none text-mediumpurple">مشاهده کنید<i
                            class="fa-solid fa-arrow-left"></i></a>
                </div>
                <div class="container position-absolute bottom-50 z-2">
                    <div class="position-relative index-owl-nav"></div>
                ...
                <div class="owl-center-nonloop owl-carousel">
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5371" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Clothing&group=multipacks&item=5371" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                ASOS DESIGN 14k gold plated pack of 4 rings with set stones in gold tone                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                حلقه                                                -
                                                ASOS DESIGN                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۱,۰۵۶,۰۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4722" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=dresses&group=party-dresses&item=4722" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Bershka metallic bodycon maxi dress in metallic silver                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                پیراهن                                                -
                                                Bershka                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۲,۳۲۳,۲۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4650" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Clothing&group=skirts&item=4650" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Collective the Label exclusive disc sequin mini skirt in bright pink                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                دامن                                                -
                                                Collective The Label                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۲,۶۷۵,۲۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4976" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Clothing&group=tops&item=4976" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                COLLUSION knitted open stitch shirt cardigan in burnt rust                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                تیشرت                                                -
                                                Collusion                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۲,۰۴۰,۸۹۶ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4463" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Accessories&group=bags-purses&item=4463" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                True Decadence clutch bag with pearl embellished strap in champagne satin                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                کیف                                                -
                                                True Decadence                                            </h6>
                                        </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4564" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=Shoes&group=heels&item=4564" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                ASOS DESIGN Sia corsage slingback mid heeled shoes in black                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                کفش                                                -
                                                ASOS DESIGN                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۲,۴۶۴,۰۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5301" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=women&category=dresses&group=midi-dresses&item=5301" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                            <div class="text-bg-danger p-1 mb-2 position-absolute bottom-0 end-0"><small>تخفیف</small></div>                                        </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                ASOS DESIGN Curve tie back fluted sleeve pleated chevron chiffon midi dress in green                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                پیراهن                                                -
                                                ASOS Curve                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۳,۰۹۷,۶۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
  ...
  <div class="text-dark"
    style="background-color: #ef0369;">
    <div class="container-md">
      <div class="row pt-5 ps-4 ps-md-0 position-relative placeholder-glow">
        <div class="col-12 col-md-6 py-3">
          <h3 class="fw-semibold">
            زیبایی را به رخ بکش          </h3>
          <h4 class="mb-4">
            تن جامه نسل جدید زیبایی          </h4>
          <a href="https://new.tanjameh.com/?gender=men&category=Clothing&group=shirts&CatId=3602" class="text-decoration-none text-dark fw-semibold stretched-link">
            مشاهده کنید<i
              class="fa-solid fa-arrow-left"></i>
          </a>
        ...
        <div class="col-12 col-md-6 card p-0 rounded-0 border-0">
          <div class="position-relative pt-48 bg-dark-subtle placeholder">
            <img class="lazy-image position-absolute top-0 w-100"
              data-src="./irepository/img/adver_banner/tanjameh-1687975806-66514582.webp"
              alt="زیبایی را به رخ بکش">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-12 col-md-11 position-relative overflow-hidden">
        ...
        <div class="owl-center-nonloop owl-carousel">
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4871" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Accessories&group=bags-purses&item=4871" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        River Island raffia clutch bag with faux leather detail in beige                      </h6>
                      <h6 class="m-0 text-truncate">
                      کیف                        -
                        River Island                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5137" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=skirts&item=5137" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        COLLUSION puff ball midi skirt in black                      </h6>
                      <h6 class="m-0 text-truncate">
                      دامن                        -
                        Collusion                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۲,۱۸۱,۶۹۶ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5015" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=tops&item=5015" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        COLLUSION fitted tshirt in grey marl                      </h6>
                      <h6 class="m-0 text-truncate">
                      تی شرت                        -
                        Collusion                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۴۹۲,۰۹۶ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5182" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=jumpers-cardigans&item=5182" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                        <div class="text-bg-danger p-1 mb-2"><small>تخفیف</small></div>                      </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        ASOS DESIGN off shoulder jumper in rib in cream                      </h6>
                      <h6 class="m-0 text-truncate">
                      لباس بافتنی                        -
                        ASOS DESIGN                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5052" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=Clothing&group=shorts&item=5052" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                        <div class="text-bg-danger p-1 mb-2"><small>تخفیف</small></div>                      </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        ASOS LUXE embellished boucle shorts in pink                      </h6>
                      <h6 class="m-0 text-truncate">
                      شرت                        -
                        ASOS Luxe                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۳,۶۶۰,۸۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5313" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=women&category=dresses&group=maxi-dresses&item=5313" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        ASOS DESIGN satin fallen shoulder cowl maxi dress with back strap detail in champagne                      </h6>
                      <h6 class="m-0 text-truncate">
                      پیراهن                        -
                        ASOS DESIGN                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۳,۸۷۲,۰۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
  ...
  <div class="container-md my-5">
    ...
    <div class="row row-cols-md-4 row-cols-2 mt-4 lh-lg text-truncate b-animate b-dark">
                  <div class="col">
                    <a class="nav-link" href="?brand=WALK LONDON&id=36">
          WALK LONDON        </a>
                  </div>
          ...
          Commando        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Flamingo&id=210">
          Flamingo        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Coco & Eve&id=143">
          Coco & Eve        </a>
                  </div>
          ...
          adidas Originals        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Billabong&id=357">
          Billabong        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Urban Revivo&id=269">
          Urban Revivo        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=JDY Tall&id=314">
          JDY Tall        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=NEOM&id=189">
          NEOM        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Be Mine Wide Fit&id=224">
          Be Mine Wide Fit        </a>
                  </div>
          ...
          Dune        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Speedo&id=239">
          Speedo        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Tommy Jeans&id=133">
          Tommy Jeans        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Superdry&id=32">
          Superdry        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=I Saw It First&id=397">
          I Saw It First        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Loungeable&id=177">
          Loungeable        </a>
                  </div>
  ...
  <div class="container-md my-5">
    ...
    <div class="row row-cols-md-4 row-cols-2 mt-4 lh-lg text-truncate b-animate b-dark">
                  <div class="col">
                    <a class="nav-link" href="?trend=Bikini Tops&id=129">
          Bikini Tops        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?trend=Blazers&id=20">
          Blazers        </a>
                  </div>
          ...
          Body Moisturisers        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Crop Tops&id=82">
          Crop Tops        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?trend=Hygiene Products&id=132">
          Hygiene Products        </a>
                  </div>
          ...
          Leave-in Treatments        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Chinos&id=32">
          Chinos        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?trend=Facial Exfoliators&id=125">
          Facial Exfoliators        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?trend=Hair Oils&id=176">
          Hair Oils        </a>
                  </div>
          ...
          Eye Creams        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Tanning Sets&id=166">
          Tanning Sets        </a>
                  </div>
    ...
    <div class="row">
      ...
      <div class="col-12 col-md-7">
        <div class="card px-md-5 py-md-2 rounded-0 border-0">
          <form id="newsletter" method="post" class="form-validation card-body" role="form" novalidate>
            <div class="col">
              <label for="validationEmail" class="form-label m-0 p-1 border border-bottom-0 border-dark">ایمیل
                شما:</label>
              <div class="input-group has-validation">
                <input type="email" class="form-control rounded-0 border-dark" placeholder="example@email.com"
            ...
            <div class="accordion" id="accordionNewsletter">
              <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  data-bs-parent="#accordionNewsletter">
                  <div class="accordion-body">
                    ...
                    <a href="#" class="text-decoration-none font-x-s text-mediumpurple">مشاهده بیشتر (باید وارد سیستم
                      شوید)</a>
                  </div>
                </div>
              </div>
            </div>
            <button class="btn w-100 my-3 text-bg-dark rounded-0" type="submit">ثبت خبرنامه</button>
            <small class="text-muted">برای آشنایی با نحوه پردازش داده های شما، از اعلامیه <a href="#"
                class="text-dark text-decoration-none">حریم خصوصی</a> ما دیدن کنید. شما می توانید در هر زمان و بدون
              هزینه <a href="#" class="text-dark text-decoration-none">اشتراک</a> خود را لغو کنید.</small>
          </form>
          <div id="newsletterResult" class="hstack gap-5 pt-3"></div>
        </div>
      </div>
    </div>
  </div>
</div><div class="bg-mediumpurple footer-two py-1 py-md-5 mt-5">
  <div class="container-md">
