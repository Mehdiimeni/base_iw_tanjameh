        ...
        <div class="col-12 col-md-6 card p-0 rounded-0 border-0">
          <div class="position-relative pt-48 bg-dark-subtle placeholder">
            <img class="lazy-image position-absolute top-0 w-100"
              data-src="./irepository/img/adver_banner/tanjameh-1687975990-876629671.webp"
              alt="خودت را دوست داشته باش">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-12 col-md-11 position-relative overflow-hidden">
        ...
        <div class="owl-center-nonloop owl-carousel">
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4992" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Clothing&group=polo-shirts&item=4992" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Calvin Klein stretch slim fit button up polo in purple                      </h6>
                      <h6 class="m-0 text-truncate">
                        پولو شرت                        -
                        Calvin Klein                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="4984" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Clothing&group=shirts&item=4984" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        COLLUSION open stitch knitted shirt in rust                      </h6>
                      <h6 class="m-0 text-truncate">
                        تیشرت                        -
                        Collusion                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="4732" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Accessories&group=ties&item=4732" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Noak slim tie and pocket square in blue houndstooth                      </h6>
                      <h6 class="m-0 text-truncate">
                        کروات                        -
                        Noak                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۱,۳۳۷,۶۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="5127" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Clothing&group=jackets-coats&item=5127" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Bershka nylon utility jacket in blue                       </h6>
                      <h6 class="m-0 text-truncate">
                        کاپشن و بارونی                        -
                        Bershka                      </h6>
                    </div>
                ...
                <a href="?gender=men&category=Clothing&group=sportswear&item=4479" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    ...
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۲,۱۴۷,۲۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  <!-- add class like or dislike -->
                  <button type="button" value="4626" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Accessories&group=ties&item=4626" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        ASOS Design slim ditsy floral tie in navy                      </h6>
                      <h6 class="m-0 text-truncate">
                        کروات                        -
                        ASOS DESIGN                      </h6>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-11 position-relative overflow-hidden">
                ...
                <div class="hstack b-animate b-dark">
                    ...
                    <a href="https://new.tanjameh.com/?gender=men&category=Clothing&group=shirts&CatId=3602"
                        class="ms-auto text-decoration-none text-mediumpurple">خرید<i
                ...
                <div class="owl-center-nonloop owl-carousel">
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4515" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=men&category=Clothing&group=sportswear&item=4515" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                        ...
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                adidas Originals 3 pack solid socks in black                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                جوراب                                                -
                                                adidas Originals                                            </h6>
                                        </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5260" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=men&category=Clothing&group=shorts&item=5260" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Selected Homme cotton mix denim short in off white                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                شرت                                                -
                                                Selected Homme                                            </h6>
                                        </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4960" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=men&category=Shoes%2C+Boots+%26+Trainers&group=sportswear&item=4960" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Converse CT70 Trek trainers in black                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                کفش ورزشی                                                -
                                                Converse                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۸,۴۴۸,۰۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4994" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=men&category=Clothing&group=shirts&item=4994" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Viggo contour print shirt in red                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                تیشرت                                                -
                                                Viggo                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۴,۲۲۴,۰۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5279" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=men&category=Clothing&group=shorts&item=5279" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                        ...
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Berghaus Navigator 2.0 shorts in navy                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                شرت                                                -
                                                Berghaus                                            </h6>
                                        </div>
                                ...
                                <a href="?gender=men&category=Clothing&group=shirts&item=4984" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        ...
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۲,۳۲۲,۴۹۶ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5151" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=men&category=Clothing&group=jackets-coats&item=5151" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Nike Windrunner insulated gilet in khaki                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                Gilets                                                -
                                                Nike                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۱۰,۲۰۴,۴۸۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                ...
                <div class="owl-center-nonloop owl-carousel">
                                ...
                                <a href="?gender=men&category=Clothing&group=trousers-chinos&item=4798" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        ...
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۱,۷۶۰,۰۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4447" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=men&category=Clothing&group=polo-shirts&item=4447" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                ASOS DESIGN relaxed long sleeve polo with revere collar in beige ribbed velour                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                پولو شرت                                                -
                                                ASOS DESIGN                                            </h6>
                                        </div>
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۱,۸۳۰,۴۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="4655" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=men&category=Clothing&group=jumpers-cardigans&item=4655" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                                                                    </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Topman knitted rib crewneck jumper in khaki                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                لباس بافتنی                                                -
                                                Topman                                            </h6>
                                        </div>
                                ...
                                <a href="?gender=men&category=Clothing&group=t-shirts-vests&item=5307" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        ...
                                        <section>
                                            <h6>
                                                <h6 class="fw-semibold">۱,۶۸۹,۶۰۰ تومان</h6>                                            </h6>
                                        </section>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="position-absolute top-0 z-1 mt-2">
                                    ...
                                    <button type="button" value="5026" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                                            class="fa-regular fa-heart" aria-hidden="true"></i></button>
                                </div>
                                <a href="?gender=men&category=Clothing&group=shirts&item=5026" class="text-decoration-none">
                                    <div class="card text-dark rounded-0 border-0 bg-transparent">
                                        <div class="position-relative">
                                            <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                                            <div class="text-bg-danger p-1 mb-2 position-absolute bottom-0 end-0"><small>تخفیف</small></div>                                        </div>
                                        <div class="card-body p-0 py-2">
                                            <h6 class="m-0 text-truncate">
                                                Topman short sleeve slim fit formal shirt in black                                            </h6>
                                            <h6 class="m-0 text-truncate">
                                                تیشرت                                                -
                                                Topman                                            </h6>
                                        </div>
    ...
    <div class="container-md">
      <div class="row pt-5 ps-4 ps-md-0 position-relative placeholder-glow">
        ...
        <div class="col-12 col-md-6 card p-0 rounded-0 border-0">
          <div class="position-relative pt-48 bg-dark-subtle placeholder">
            <img class="lazy-image position-absolute top-0 w-100"
              data-src="./irepository/img/adver_banner/tanjameh-1687975362-662881957.webp"
              alt="یک مرد بروز">
          </div>
        </div>
      </div>
      ...
      <div class="col-12 col-md-11 position-relative overflow-hidden">
        ...
        <div class="owl-center-nonloop owl-carousel">
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5383" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Clothing&group=loungewear&item=5383" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Threadbare coast woven pyjama set in red and navy check                      </h6>
                      <h6 class="m-0 text-truncate">
                      ست لباس راحتی                        -
                        Threadbare                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5268" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Clothing&group=shorts&item=5268" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Tommy Hilfiger 1985 harlem short in blue                      </h6>
                      <h6 class="m-0 text-truncate">
                      شرت                        -
                        Tommy Hilfiger                      </h6>
                    </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="4822" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Shoes%2C+Boots+%26+Trainers&group=sliders-flip-flops&item=4822" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                                              </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Havaianas Top Logomania flip flops in black                      </h6>
                      <h6 class="m-0 text-truncate">
                      دمپایی فیلیپ فلاپ                        -
                        Havaianas                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۲,۰۴۱,۶۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
                ...
                <div class="position-absolute top-0 z-1 mt-2">
                  ...
                  <button type="button" value="5001" class="btn btn-light rounded-0 btn-heart dislike lh-1 p-2 fs-5"><i
                      class="fa-regular fa-heart" aria-hidden="true"></i></button>
                </div>
                <a href="?gender=men&category=Clothing&group=polo-shirts&item=5001" class="text-decoration-none">
                  <div class="card text-dark rounded-0 border-0 bg-transparent">
                    <div class="position-relative">
                      <img class="card-img rounded-0 owl-lazy" data-src="./itemplates/ipanel/build/icon/no-image.jpg" width="100%" height="auto" alt="no image" title="no image">                      <div class="position-absolute bottom-0 end-0 hstack gap-1">
                        <div class="text-bg-danger p-1 mb-2"><small>تخفیف</small></div>                      </div>
                    ...
                    <div class="card-body p-0 py-2">
                      <h6 class="m-0 text-truncate">
                        Armani Exchange 91 back print polo shirt in khaki                      </h6>
                      <h6 class="m-0 text-truncate">
                      پولو شرت                        -
                        Armani Exchange                      </h6>
                    </div>
                    <section>
                      <div class="hstack gap-3">
                        <h6 class="fw-semibold">۴,۵۰۵,۶۰۰ تومان</h6>                      </div>
                    </section>
                                      </div>
                </a>
              </div>
  ...
  <div class="container-md my-5">
    ...
    <div class="row row-cols-md-4 row-cols-2 mt-4 lh-lg text-truncate b-animate b-dark">
          ...
          Messy Weekend        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Starlet&id=311">
          Starlet        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Wrangler Plus&id=232">
          Wrangler Plus        </a>
                  </div>
          ...
          Waven        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Little Mistress&id=271">
          Little Mistress        </a>
                  </div>
          ...
          Kylie Cosmetics by Kylie Jenner        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Brave Soul Plus&id=141">
          Brave Soul Plus        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Teva&id=37">
          Teva        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=BOSS by Hugo Boss&id=35">
          BOSS by Hugo Boss        </a>
                  </div>
          ...
          My Accessories Curve        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Closet London&id=349">
          Closet London        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Nike&id=4">
          Nike        </a>
                  </div>
  ...
  <div class="container-md my-5">
    ...
    <div class="row row-cols-md-4 row-cols-2 mt-4 lh-lg text-truncate b-animate b-dark">
          ...
          Eyebrow Kits        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Slips&id=172">
          Slips        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?trend=Concealers&id=178">
          Concealers        </a>
                  </div>
          ...
          Swim Trunks        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Purses&id=48">
          Purses        </a>
                  </div>
          ...
          Nail Clippers        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Hair Extensions&id=76">
          Hair Extensions        </a>
                  </div>
          ...
          Wallets        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Belts&id=31">
          Belts        </a>
                  </div>
          ...
          Hair Treatments        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?trend=Compression Shorts&id=173">
