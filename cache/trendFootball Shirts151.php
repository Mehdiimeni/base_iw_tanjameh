...
<div class="offcanvas offcanvas-start cat-offcanvas" tabindex="-1" id="offcanvasHome"
  ...
  <div class="row my-4">
    ...
    <div class="row row-cols-md-4 row-cols-2 mt-4 lh-lg text-truncate b-animate b-dark">
                  <div class="col">
                    <a class="nav-link" href="?brand=JDY Petite&id=315">
          JDY Petite        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=Rains&id=147">
          Rains        </a>
                  </div>
        
                <div class="col">
                    <a class="nav-link" href="?brand=ASOS Maternity&id=198">
          ASOS Maternity        </a>
                  </div>
          ...
          Only & Sons        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Nike Golf&id=20">
          Nike Golf        </a>
                  </div>
          ...
          Love Moschino        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Noak&id=428">
          Noak        </a>
                  </div>
          ...
          GUESS Originals        </a>
                ...
                <div class="col">
                    <a class="nav-link" href="?brand=Farah&id=23">
          Farah        </a>
                  </div>
