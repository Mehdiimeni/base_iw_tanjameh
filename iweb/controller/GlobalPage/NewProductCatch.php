...
$SCondition = "1 ";
foreach ($objORM->FetchAll($SCondition, 'CatId,Name,LocalName,NewMenuId,GroupIdKey,iw_product_weight_id,Enabled,id,ModifyStrTime', TableIWNewMenu3) as $ListItem) {
