      ...
      <div class="owl-center-nonloop owl-carousel">
        ...
        <div class="item position-relative">
          ...
          <a href="product-detail.html" class="text-decoration-none">
            <div class="card text-dark rounded-0 border-0 bg-transparent">
              <div class="position-relative">
                <img data-src="media/men/men-a2.webp" class="card-img rounded-0 owl-lazy" alt="...">
        ...
        <div class="item position-relative">
          ...
          <a href="product-detail.html" class="text-decoration-none">
            <div class="card text-dark rounded-0 border-0 bg-transparent">
              <div class="position-relative">
                <img data-src="media/men/men-a3.webp" class="card-img rounded-0 owl-lazy" alt="...">
              </div>
              <div class="card-body p-0 py-2">
        ...
        <div class="item position-relative">
          ...
          <a href="product-detail.html" class="text-decoration-none">
            <div class="card text-dark rounded-0 border-0 bg-transparent">
              <div class="position-relative">
                <img data-src="media/men/men-a4.webp" class="card-img rounded-0 owl-lazy" alt="...">
              </div>
              <div class="card-body p-0 py-2">
                <h6 class="m-0 text-truncate">HOSBJERG</h6>
                <h6 class="m-0 text-truncate">شلوار ALEXA CUFF - شلوار - آبی</h6>
        ...
        <div class="item position-relative">
          ...
          <a href="product-detail.html" class="text-decoration-none">
            <div class="card text-dark rounded-0 border-0 bg-transparent">
              <div class="position-relative">
                <img data-src="media/men/men-a5.webp" class="card-img rounded-0 owl-lazy" alt="...">
              </div>
              <div class="card-body p-0 py-2">
                <h6 class="m-0 text-truncate">HOSBJERG</h6>
                <h6 class="m-0 text-truncate">شلوار ALEXA CUFF - شلوار - آبی</h6>
        ...
        <div class="item position-relative">
          ...
          <a href="product-detail.html" class="text-decoration-none">
            <div class="card text-dark rounded-0 border-0 bg-transparent">
              <div class="position-relative">
                <img data-src="media/men/men-a6.webp" class="card-img rounded-0 owl-lazy" alt="...">
              </div>
              <div class="card-body p-0 py-2">
                <h6 class="m-0 text-truncate">HOSBJERG</h6>
                <h6 class="m-0 text-truncate">شلوار ALEXA CUFF - شلوار - آبی</h6>
