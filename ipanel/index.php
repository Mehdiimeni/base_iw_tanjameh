...
(new MakeDirectory)->MKDir( '../irepository/log/error/', 'ipanel', 0755);
$objInitTools = new InitTools($objFileToolsInit->KeyValueFileReader(),  '../irepository/log/error/ipanel/adminerror.log');
