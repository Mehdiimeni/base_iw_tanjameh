...
$strListBody = '';
foreach ($objORM->FetchAllWhitoutCondition('Name,PartName,FaIcon,Enabled,TableName,id', TableIWPanelAdminPart) as $ListItem) {
...
$strListBody .= (new ListTools())->TableBody($ListItem, $ToolsIcons, 4, $objGlobalVar->en2Base64($ListItem->id . '::==::' . TableIWPanelAdminPart, 0));
}
