...
$strListBody = '';
foreach ($objORM->FetchAllWhitoutCondition('IdKey,Name,PartName,FaIcon,Enabled,TableName,IdRow', TableIWPanelUserPart) as $ListItem) {
...
$strListBody .= (new ListTools())->TableBody($ListItem, $ToolsIcons, 4, $objGlobalVar->en2Base64($ListItem->IdKey . '::==::' . TableIWPanelUserPart, 0));
}
