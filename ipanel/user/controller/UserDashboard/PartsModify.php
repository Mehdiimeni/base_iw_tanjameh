...
if (isset($_POST['SubmitM']) and @$objGlobalVar->RefFormGet()[0] == null) {
    ...
    if ($objAclTools->CheckNull($objAclTools->PostVarToJson())) {
        ...
        if ($objORM->DataExist($SCondition, TableIWPanelUserPart)) {
            ...
            $objORM->DataAdd($InSet, TableIWPanelUserPart);
...
if(@$objGlobalVar->RefFormGet()[0] != null)
{
    ...
    $objEditView = $objORM->Fetch($SCondition, 'Name,PartName,FaIcon,Description,TableName', TableIWPanelUserPart);
    ...
    if (isset($_POST['SubmitM']) ) {
        ...
        if ($objAclTools->CheckNull($objAclTools->PostVarToJson())) {
            ...
            if ($objORM->DataExist($SCondition, TableIWPanelUserPart)) {
                ...
                $objORM->DataUpdate($UCondition,$USet, TableIWPanelUserPart);
