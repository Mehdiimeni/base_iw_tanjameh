    ...
    <div class="main_container">
        <div class="col-md-3 left_col hidden-print">
            <div class="left_col scroll-view">
                                <?php (new FileCaller)->FileIncluderWithControler(IW_PANEL_FROM_PANEL . 'user/', 'GlobalPage', 'PanelPageTitle'); ?>
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left input_mask" method="post" action="">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["part_name"]; ?>
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <select name="iw_panel_user_part_id" class="form-control" required="required">
                                                <?php echo $strPartIdKey; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["page_name"]; ?>
                                            <span
                                                    class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="PageName" class="date-picker form-control col-md-7 col-xs-12"
                                                   required="required" type="text"
                                                   value="<?php echo @$objEditView->PageName; ?>">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["table_name"]; ?>
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <select name="TableName" class="form-control" required="required">
                                                <?php echo $strTableNames; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["edit_access"]; ?>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="SuperAdmin" type="checkbox" class="js-switch"
                                                   value="<?php $objEditView->TopModify == null ? $value = 1 : $value = $objEditView->TopModify;
                                                   echo $value;  ?>" <?php if ($objEditView->TopModify == 1) echo 'checked'?> >
                                        </div>
                                    </div>
                                    <div class="form-group">
