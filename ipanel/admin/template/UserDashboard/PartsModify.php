<?php
///template/UserDashboard/PartsModify.php
?>
<?php
//PartsModify.php
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left input_mask" method="post" action="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="PartName" class="date-picker form-control col-md-7 col-xs-12"
                                                   required="required" type="text"
                                                   value="<?php echo @$objEditView->PartName; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="FaIcon"
                                                   value="<?php !isset($objEditView->FaIcon) ? $value = FA_LC["icon"] : $value = $objEditView->FaIcon;
                                                   echo $value; ?>"
