<?php
///template/UserBasket/DispatchModify.php
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left input_mask" method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo 'CopFile'; ?>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="CopFile" class="date-picker form-control col-md-7 col-xs-12"
                                                   type="file"
                                                   value="<?php echo @$objEditView->CopFile; ?>">
                                        </div>
                                    </div>
