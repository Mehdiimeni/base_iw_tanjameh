<?php
///template/Structure/WebSiteSpAdver.php
...
<head>
    ...
    <!-- Bootstrap -->
    <link href="<?php echo (IW_PANEL_THEME_FROM_PANEL); ?>vendors/bootstrap/dist/css/bootstrap.min.css"
        rel="stylesheet">
    ...
    <link
        href="<?php echo (IW_PANEL_THEME_FROM_PANEL); ?>vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css"
        rel="stylesheet">
    <!-- iCheck -->
    ...
    <link href="<?php echo (IW_PANEL_THEME_FROM_PANEL); ?>vendors/datatables.net-bs/css/dataTables.bootstrap.min.css"
        rel="stylesheet">
    <link
        href="<?php echo (IW_PANEL_THEME_FROM_PANEL); ?>vendors/datatables.net-buttons-bs/css/buttons.bootstrap.min.css"
        rel="stylesheet">
    <link
        href="<?php echo (IW_PANEL_THEME_FROM_PANEL); ?>vendors/datatables.net-fixedheader-bs/css/fixedHeader.bootstrap.min.css"
        rel="stylesheet">
    <link
        href="<?php echo (IW_PANEL_THEME_FROM_PANEL); ?>vendors/datatables.net-responsive-bs/css/responsive.bootstrap.min.css"
        rel="stylesheet">
    <link
        href="<?php echo (IW_PANEL_THEME_FROM_PANEL); ?>vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css"
        rel="stylesheet">
...
<body class="nav-md">
                                    ...
                                    <ul class="nav navbar-right panel_toolbox">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li>
                                                    <a
                                                        href="<?php echo $objGlobalVar->setGetVar('list', 'export', array('act')); ?>"><?php echo FA_LC["list_export_mode"]; ?></a>
                                                </li>
                                                <li>
                                                    <a
                                                        href="<?php echo $objGlobalVar->setGetVar('list', 'extend', array('act')); ?>"><?php echo FA_LC["list_extend_mode"]; ?></a>
                                                </li>
                                                <li>
                                                    <a
                                                        href="<?php echo $objGlobalVar->setGetVar('list', 'normal', array('act')); ?>"><?php echo FA_LC["list_normal_mode"]; ?></a>
                                                </li>
                                            </ul>
                                        </li>
    ...
    <!-- bootstrap-progressbar -->
    <script
        src="<?php echo (IW_PANEL_THEME_FROM_PANEL); ?>vendors/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
    <!-- iCheck -->
    ...
    <script
        src="<?php echo (IW_PANEL_THEME_FROM_PANEL); ?>vendors/bootstrap-daterangepicker/daterangepicker.js"></script>
    ...
    <script
        src="<?php echo (IW_PANEL_THEME_FROM_PANEL); ?>vendors/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
    <script
        src="<?php echo (IW_PANEL_THEME_FROM_PANEL); ?>vendors/datatables.net-buttons/js/dataTables.buttons.min.js"></script>
    <script
        src="<?php echo (IW_PANEL_THEME_FROM_PANEL); ?>vendors/datatables.net-buttons-bs/js/buttons.bootstrap.min.js"></script>
    <script
        src="<?php echo (IW_PANEL_THEME_FROM_PANEL); ?>vendors/datatables.net-buttons/js/buttons.flash.min.js"></script>
    <script
        src="<?php echo (IW_PANEL_THEME_FROM_PANEL); ?>vendors/datatables.net-buttons/js/buttons.html5.min.js"></script>
    <script
        src="<?php echo (IW_PANEL_THEME_FROM_PANEL); ?>vendors/datatables.net-buttons/js/buttons.print.min.js"></script>
    <script
        src="<?php echo (IW_PANEL_THEME_FROM_PANEL); ?>vendors/datatables.net-fixedheader/js/dataTables.fixedHeader.min.js"></script>
    <script
        src="<?php echo (IW_PANEL_THEME_FROM_PANEL); ?>vendors/datatables.net-keytable/js/dataTables.keyTable.min.js"></script>
    <script
        src="<?php echo (IW_PANEL_THEME_FROM_PANEL); ?>vendors/datatables.net-responsive/js/dataTables.responsive.min.js"></script>
    <script
        src="<?php echo (IW_PANEL_THEME_FROM_PANEL); ?>vendors/datatables.net-responsive-bs/js/responsive.bootstrap.js"></script>
    <script
        src="<?php echo (IW_PANEL_THEME_FROM_PANEL); ?>vendors/datatables.net-scroller/js/dataTables.scroller.min.js"></script>
    ...
    <script src="<?php echo (IW_PANEL_JSON_FROM_PANEL); ?>OnClickAddName.js"></script>
