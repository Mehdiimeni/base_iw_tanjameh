<?php
///template/Users/UsersModify.php
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left input_mask" method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["card"]; ?>

                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="Card" class=" form-control col-md-7 col-xs-12"
                                                  type="text"
                                                   data-inputmask="'mask' : '9999-9999-9999-9999'">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["national_code"]; ?>

                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="NationalCode" class="date-picker form-control col-md-7 col-xs-12"
                                                   type="text" maxlength="10"
                                                   value="<?php echo @$objEditView->NationalCode; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["mobile"]; ?>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["username"]; ?>
                                            <span
                                                    class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="Username" class="date-picker form-control col-md-7 col-xs-12"
                                                   required="required" type="text"
                                                   value="<?php  echo @$trueUsername; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["password"]; ?>
                                            <span
                                                    class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="Password" class="date-picker form-control col-md-7 col-xs-12"
                                                   ...
                                                   value="<?php echo @$objEditView->Password; ?>">
                                        </div>
                                    </div>
...
<!-- jquery.inputmask -->
<script src="<?php echo(IW_PANEL_THEME_FROM_PANEL); ?>vendors/jquery.inputmask/dist/min/jquery.inputmask.bundle.min.js"></script>
