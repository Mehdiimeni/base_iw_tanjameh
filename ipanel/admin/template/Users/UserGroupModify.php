<?php
///template/Users/UserGroupModify.php
?>
<?php
//UserGroupModify.php
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left input_mask" method="post" action="">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["super_user"]; ?>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="SuperUser" type="checkbox" class="js-switch"
                                                   value="<?php !isset($objEditView->SuperUser) ? $value = 1 : $value = $objEditView->SuperUser;
                                                   echo $value; ?>" <?php if (@$objEditView->SuperUser == 1) echo 'checked' ?> >
                                        </div>
                                    </div>
