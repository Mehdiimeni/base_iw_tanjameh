<?php
///template/Admins/NotificationModify.php
?>
<?php
                                ...
                                <form class="form-horizontal form-label-left input_mask" method="post" action=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <select name="AdminIdKey" class="form-control" required="required">
                                                <?php echo $strAdminIdKey; ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="Email" type="checkbox" class="js-switch"
                                                   value="<?php !isset($objEditView->Email) ? $value = 1 : $value = $objEditView->Email;
                                                   echo $value; ?>" <?php if (@$objEditView->Email == 1) echo 'checked' ?> >
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["sms"]; ?>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="Sms" type="checkbox" class="js-switch"
                                                   value="<?php !isset($objEditView->Sms) ? $value = 1 : $value = $objEditView->Sms;
                                                   echo $value; ?>" <?php if (@$objEditView->Sms == 1) echo 'checked' ?> >
                                        </div>
                                    </div>
