<?php
///template/Admins/AdminGroupModify.php
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left input_mask" method="post" action="">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["super_admin"]; ?>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="SuperAdmin" type="checkbox" class="js-switch"
                                                   value="<?php !isset($objEditView->SuperAdmin) ? $value = 1 : $value = $objEditView->SuperAdmin;
                                                   echo $value;  ?>" <?php if (@$objEditView->SuperAdmin == 1) echo 'checked'?> >
                                        </div>
                                    </div>
                                    <div class="form-group">
