<?php
///template/Ticket/UserTicketModify.php
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left input_mask" method="post" action="">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["subject"]; ?>
                                            <span
                                                    class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="TicketSubject" class="date-picker form-control col-md-7 col-xs-12"
                                                   required="required" type="text"
                                                   value="<?php echo @$objEditView->TicketSubject; ?>">
                                        </div>
                                    </div>


                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["message"]; ?>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <textarea name="SenderTicket" class="form-control" rows="3"
                                                      placeholder="<?php echo FA_LC["message"]; ?>"><?php echo @$objEditView->SenderTicket; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["response"]; ?>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <textarea name="AnswerTicket" class="form-control" rows="3"
                                                      placeholder="<?php echo FA_LC["response"]; ?>"><?php echo @$objEditView->AnswerTicket; ?></textarea>
                                        </div>
                                    </div>
