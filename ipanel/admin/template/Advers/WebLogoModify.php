<?php
///template/Advers/WebLogoModify.php
?>
<?php
//WebLogoModify.php
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left input_mask" method="post" action=""
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["icon"]; ?>

                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="Icon" class="date-picker form-control col-md-7 col-xs-12"
                                                    type="text"
                                                   value="<?php echo @$objEditView->Icon; ?>">
                                        </div>
                                    </div>
