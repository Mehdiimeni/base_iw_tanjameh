<?php
///template/Advers/BannerModify.php
?>
<?php
//BannerModify.php
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left input_mask" method="post" action=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="BottomCaption"
                                                   class="date-picker form-control col-md-7 col-xs-12"
                                                    type="text"
                                                   value="<?php echo @$objEditView->BottomCaption; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["link_to"]; ?>

                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="LinkTo" class="date-picker form-control col-md-7 col-xs-12"
                                                   type="url"
                                                   value="<?php echo @$objEditView->LinkTo; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["position"]; ?>
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["color"]; ?>

                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="SelectColor" class="date-picker form-control col-md-7 col-xs-12"
                                                   type="color"
                                                   value="<?php echo @$objEditView->SelectColor; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["titer_line"]; ?>

                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="Line1" class="date-picker form-control col-md-7 col-xs-12"
                                                    type="text"
                                                   value="<?php echo @$objEditView->Line1; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["main_line"]; ?>
                                            <span
                                                    class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="Line2" class="date-picker form-control col-md-7 col-xs-12"
                                                   required="required" type="text"
                                                   value="<?php echo @$objEditView->Line2; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["description_line"]; ?>

                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="Line3" class="date-picker form-control col-md-7 col-xs-12"
                                                    type="text"
                                                   value="<?php echo @$objEditView->Line3; ?>">
                                        </div>
                                    </div>
