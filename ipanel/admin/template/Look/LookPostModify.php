                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input  class="date-picker form-control col-md-7 col-xs-12"
                                                   readonly type="text"
                                                   value="<?php echo @$objEditView->user_id; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <select name="stat" class="form-control" required="required">

                                            <?php  foreach($arrAcceptStat as $stat_id => $stat_value){ 
                                                $selected = '';
                                                if($objEditView->stat == $stat_id) $selected = 'selected';
                                                ?>
                                                <option <?php echo($selected); ?> value="<?php echo($stat_id); ?>"><?php echo($stat_value); ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
