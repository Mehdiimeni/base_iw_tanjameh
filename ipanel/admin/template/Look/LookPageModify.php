                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left input_mask" method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["user"]; ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="LookPageName" class="date-picker form-control col-md-7 col-xs-12"
                                                   required="required" type="text"
                                                   value="<?php echo @$objEditView->LookPageName; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <textarea name="LookTitle" class="form-control" rows="3"
                                                      placeholder="<?php echo FA_LC["subject"]; ?>"><?php echo @$objEditView->LookTitle; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="LookPageImage" class="date-picker form-control col-md-7 col-xs-12"
                                                   type="file"
                                                   value="<?php echo @$objEditView->LookPageImage; ?>">
                                        </div>
                                    </div>
