<?php
///template/Dashboard/PagesModify.php
                                ...
                                <form class="form-horizontal form-label-left input_mask" method="post" action="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <select name="iw_panel_admin_part_id" class="form-control" required="required">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="TopModify" type="checkbox" class="js-switch"
