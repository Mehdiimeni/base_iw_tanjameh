            ...
            <div class="">
                ...
                <div class="row">
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left input_mask" method="post" action="">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["table_db_name"]; ?>
                                            <span
                                                    class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="NameInDB" class="date-picker form-control col-md-7 col-xs-12"
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["columns"]; ?>
                                            <span
                                                    class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <textarea dir="ltr" name="Columns" class="form-control" required="required"
                                                      rows="3"
                                                      placeholder="<?php echo FA_LC["columns"]; ?>"></textarea>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2><?php echo FA_LC["tables_name"]; ?>
                                </h2>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <ul class="list-unstyled timeline">
                                    <?php echo $strTablesName; ?>
                                </ul>
                            </div>
                        </div>
                    </div>
