<?php
///template/Products/RequistApi.php
?>
<?php
//RequistApi.php
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left input_mask" method="post" action="">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["main_menu"]; ?>

                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <select name="NewMenuId" id="NewMenuId" class="form-control">
                                                <?php echo @$strNewMenuId; ?>

                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["main_menu2"]; ?>

                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <select name="GroupIdKey" id="GroupIdKey" class="form-control">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo FA_LC["main_menu3"]; ?>

                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <select name="NewMenu2Id" id="NewMenu2Id" class="form-control">
                                                <?php echo @$strNewMenu2Id; ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="ArrName" class="date-picker form-control col-md-7 col-xs-12"
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo "CatId"; ?>
                                            <span
                                                    class="required">*</span>
                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="CatId" class="date-picker form-control col-md-7 col-xs-12"
                                                   required="required" type="text">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo "Attribute"; ?>

                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="Attribute" class="date-picker form-control col-md-7 col-xs-12"
                                                   type="text">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo "Value"; ?>

                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="Value" class="date-picker form-control col-md-7 col-xs-12"
                                                   type="text">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo "Weight"; ?>

                                        </label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input name="Weight" class="date-picker form-control col-md-7 col-xs-12"
                                                   type="text">
                                        </div>
                                    </div>
                                    ...
                                    <?php if (isset($_GET['modify']) and (@$objGlobalVar->JsonDecode($objGlobalVar->GetVarToJsonNoSet())->modify != 'view')) { ?>
                                        <div class="form-group">
...
<script src="<?php echo(IW_PANEL_JSON_FROM_PANEL); ?>NewMenuPanel.js"></script>
