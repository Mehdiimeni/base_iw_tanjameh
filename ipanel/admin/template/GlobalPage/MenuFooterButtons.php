<?php
///template/GlobalPage/MenuFooterButtons.php
?>
<div class="sidebar-footer hidden-small">
    ...
    <a data-toggle="tooltip" data-placement="top" title="<?php echo FA_LC["exit"]; ?>" href="<?php echo $objGlobalVar->setGetVar('type', 'adm'); echo $objGlobalVar->setGetVar('act', 'logout'); ?>">
