...
$Enabled = true;
$strListHead = (new ListTools())->TableHead(array(FA_LC["row"], FA_LC["group_name"],  FA_LC["trade_name"],FA_LC["trade_type"],FA_LC["trade_time"],FA_LC["trade_date"],FA_LC["trade_time"]), FA_LC["tools"]);
...
$strListBody = '';
foreach ($objORM->FetchAllWhitoutCondition('IdKey,GroupIdKey,TradeIdKey,TypePosition,TimePosition,ModifyDate,ModifyTime,Enabled,IdRow', TableIWTradePosition) as $ListItem) {
