...
if (isset($_POST['SubmitM']) and @$objGlobalVar->RefFormGet()[0] == null) {
    ...
    if ($objAclTools->CheckNull($objAclTools->PostVarToJson())) {
        ...
        if ($objORM->DataExist($SCondition, TableIWTradeGroup)) {
            ...
            $objORM->DataAdd($InSet, TableIWTradeGroup);
...
if (@$objGlobalVar->RefFormGet()[0] != null) {
    ...
    $objEditView = $objORM->Fetch($SCondition, 'Name,SuperAdmin,Description', TableIWTradeGroup);
    ...
    if (isset($_POST['SubmitM'])) {
        ...
        if ($objAclTools->CheckNull($objAclTools->PostVarToJson())) {
            ...
            if ($objORM->DataExist($SCondition, TableIWTradeGroup)) {
                ...
                $objORM->DataUpdate($UCondition, $USet, TableIWTradeGroup);
