...
$strListBody = '';
foreach ($objORM->FetchAllWhitoutCondition('Name,Enabled,id', TableIWTradeGroup) as $ListItem) {
    ...
    $strListBody .= (new ListTools())->TableBody($ListItem, $ToolsIcons, 2, $objGlobalVar->en2Base64($ListItem->id . '::==::' . TableIWTradeGroup, 0));
}
