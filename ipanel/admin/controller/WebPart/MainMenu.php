...
$Enabled = true;
$strListHead = (new ListTools())->TableHead(array( FA_LC["main_name"], FA_LC["local_name"]), FA_LC["tools"]);
...
$strListBody = '';
foreach ($objORM->FetchAllWhitoutCondition('Name,LocalName,Enabled,id', TableIWWebMainMenu) as $ListItem) {

    $ListItem->LocalName = '<input type="text" class="name-main" maxlength="250" size="25" id="' . $ListItem->id . '" value="' . $ListItem->LocalName . '">';
    ...
    $strListBody .= (new ListTools())->TableBody($ListItem, $ToolsIcons, 3, $objGlobalVar->en2Base64($ListItem->id . '::==::' . TableIWWebMainMenu, 0));
}
