...
$strListBody = '';
foreach ($objORM->FetchAllWhitoutCondition('Name,LocalName,GroupIdKey,iw_product_weight_id,Enabled,id', TableIWWebSub2Menu) as $ListItem) {
    ...
    $ListItem->iw_product_weight_id =  '<input type="text" class="weight-sub2" maxlength="3" size="3" id="' . $ListItem->Name . '" value="' . @$objORM->Fetch($SCondition,'Weight',TableIWWebWeightPrice)->Weight . '">';
    ...
    $strListBody .= (new ListTools())->TableBody($ListItem, $ToolsIcons, 5, $objGlobalVar->en2Base64($ListItem->id . '::==::' . TableIWWebSub2Menu, 0));
}
