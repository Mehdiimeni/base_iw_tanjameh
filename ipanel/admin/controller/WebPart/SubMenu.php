...
$strListBody = '';
foreach ($objORM->FetchAllWhitoutCondition('Name,LocalName,GroupIdKey,iw_product_weight_id,Enabled,id', TableIWWebSubMenu) as $ListItem) {
    ...
    $strListBody .= (new ListTools())->TableBody($ListItem, $ToolsIcons, 5, $objGlobalVar->en2Base64($ListItem->id . '::==::' . TableIWWebSubMenu, 0));
}
