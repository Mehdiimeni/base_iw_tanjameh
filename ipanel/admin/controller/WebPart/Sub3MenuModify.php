...
if (!isset($_POST['SubmitApi']) and @$objGlobalVar->RefFormGet()[0] != null) {
    ...
    $SCondition = "  id = $IdKey ";
    $objEditView = $objORM->Fetch($SCondition, 'Name,LocalName,GroupIdKey,iw_product_weight_id,Description', TableIWWebSub4Menu);
    ...
    if (isset($_POST['SubmitM'])) {
        ...
        if ($objAclTools->CheckNullExcept($objAclTools->PostVarToJson(), $arrExcept)) {
            ...
            if ($objORM->DataExist($SCondition, TableIWWebSub4Menu)) {
                ...
                $objORM->DataUpdate($UCondition, $USet, TableIWWebSub4Menu);
