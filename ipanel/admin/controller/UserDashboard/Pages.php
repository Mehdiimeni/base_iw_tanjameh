...
$strListBody = '';
foreach ($objORM->FetchAllWhitoutCondition('Name,PageName,iw_panel_user_part_id,Enabled,TableName,id', TableIWPanelUserPage) as $ListItem) {

    $SCondition = "id = '$ListItem->iw_panel_user_part_id'";
    $ListItem->iw_panel_user_part_id = $objORM->Fetch($SCondition,'PartName',TableIWPanelUserPart)->PartName;
