...
$Enabled = true;
$strListHead = (new ListTools())->TableHead(array(FA_LC["name"], FA_LC["super_admin"]), FA_LC["tools"]);
...
$strListBody = '';
foreach ($objORM->FetchAllWhitoutCondition('Name,SuperAdmin,Enabled,id', TableIWAdminGroup) as $ListItem) {
    ...
    $strListBody .= (new ListTools())->TableBody($ListItem, $ToolsIcons, 2, $objGlobalVar->en2Base64($ListItem->id . '::==::' . TableIWAdminGroup, 0));
}
