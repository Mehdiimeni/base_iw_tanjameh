...
$strListBody = '';
foreach ($objORM->FetchAllWhitoutCondition('IdKey,GroupIdKey,Enabled,IdRow', TableIWAdminAccess) as $ListItem) {
    ...
    $strListBody .= (new ListTools())->TableBody($ListItem, $ToolsIcons, 2, $objGlobalVar->en2Base64($ListItem->IdKey . '::==::' . TableIWAdminAccess, 0));
}
