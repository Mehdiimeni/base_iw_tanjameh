...
$strListBody = '';
foreach ($objORM->FetchAllWhitoutCondition('iw_admin_group_id,Enabled,id', TableIWAdminAccess) as $ListItem) {
    ...
    $strListBody .= (new ListTools())->TableBody($ListItem, $ToolsIcons, 1, $objGlobalVar->en2Base64($ListItem->id . '::==::' . TableIWAdminAccess, 0));
}