...
$strListBody = '';
foreach ($objORM->FetchAllWhitoutCondition('IdKey,Name,PageName,PartIdKey,Enabled,TableName,IdRow', TableIWPanelAdminPage) as $ListItem) {

    $SCondition = "IdKey = '$ListItem->PartIdKey'";
    $ListItem->PartIdKey = $objORM->Fetch($SCondition,'PartName',TableIWPanelAdminPart)->PartName;
    ...
    $strListBody .= (new ListTools())->TableBody($ListItem, $ToolsIcons, 4, $objGlobalVar->en2Base64($ListItem->IdKey . '::==::' . TableIWPanelAdminPage, 0));
}
