...
$Enabled = true;
$strListHead = (new ListTools())->TableHead(array(FA_LC["row"], FA_LC["name"], FA_LC["part_name"], FA_LC["icon"]), FA_LC["tools"]);
...
$strListBody = '';
foreach ($objORM->FetchAllWhitoutCondition('IdKey,Name,PartName,FaIcon,Enabled,TableName,IdRow', TableIWPanelAdminPart) as $ListItem) {
...
$strListBody .= (new ListTools())->TableBody($ListItem, $ToolsIcons, 4, $objGlobalVar->en2Base64($ListItem->IdKey . '::==::' . TableIWPanelAdminPart, 0));
}
