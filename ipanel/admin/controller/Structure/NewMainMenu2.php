...
$strListBody = '';
foreach ($objORM->FetchAllWhitoutCondition('Name,LocalName,iw_new_menu_id,iw_product_weight_id,CatId,Enabled,id', TableIWNewMenu2) as $ListItem) {
    ...
    $ListItem->iw_new_menu_id = $obj_menu->Name  ;
    ...
    $ListItem->iw_product_weight_id = '<input type="text" class="weight-sub" maxlength="3" size="3" id="' . $ListItem->Name . '" value="' . $weight . '">';
