...
$Enabled = true;
$strListHead = (new ListTools())->TableHead(array( FA_LC["name"], FA_LC["title"], FA_LC["email"], FA_LC["tel"]), FA_LC["tools"]);
...
$strListBody = '';
foreach ($objORM->FetchAllWhitoutCondition('website_name,website_title,email,main_phone,Enabled,id', TableIWWebSiteInfo) as $ListItem) {
