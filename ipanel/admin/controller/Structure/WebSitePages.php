...
$Enabled = true;
$strListHead = (new ListTools())->TableHead(array( FA_LC["local_name"], FA_LC["name"]), FA_LC["tools"]);
...
$strListBody = '';
foreach ($objORM->FetchAllWhitoutCondition('title,name,Enabled,id', TableIWWebSitePages) as $ListItem) {
