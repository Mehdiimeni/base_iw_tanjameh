...
$Enabled = true;
$strListHead = (new ListTools())->TableHead(array( FA_LC["group_name"], FA_LC["name"], FA_LC["image"] ), FA_LC["tools"]);
...
$strListBody = '';
foreach ($objORM->FetchAllWhitoutCondition('GroupIdKey,Name,Image,Enabled,id', TableIWWebBanner) as $ListItem) {
    ...
    $strListBody .= (new ListTools())->TableBody($ListItem, $ToolsIcons, 4, $objGlobalVar->en2Base64($ListItem->id . '::==::' . TableIWWebBanner, 0));
}
