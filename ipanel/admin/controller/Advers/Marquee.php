...
$strListBody = '';
$SCondition = " SetPart = 'marquee'";
foreach ($objORM->FetchAll($SCondition, 'IdKey,Name,Enabled,id', TableIWAdver) as $ListItem) {
    ...
    $strListBody .= (new ListTools())->TableBody($ListItem, $ToolsIcons, 2, $objGlobalVar->en2Base64($ListItem->id . '::==::' . TableIWAdver, 0));
}
