...
$Enabled = true;
$strListHead = (new ListTools())->TableHead(array(FA_LC["company"], FA_LC["quantity"], FA_LC["date"]), FA_LC["tools"]);
...
$strListBody = '';
foreach ($objORM->FetchAllWhitoutCondition('CompanyIdKey,Count,ExpireDate,Enabled,IdRow', TableIWSMSAllConnect) as $ListItem) {
