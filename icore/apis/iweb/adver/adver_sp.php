...
if (isset($_POST['page_name_system'])) {
    ...
    if (isset($_POST['adver_number'])) {
        ...
        $condition = " Enabled = 1 and name = 'AdverSp$adver_number' and iw_web_pages_id = '$iw_web_pages_id' ";
    }

    $iw_web_pages_part_id = @$objORM->Fetch($condition, "id", TableIWWebSitePagesPart)->id;
}

echo @$objORM->FetchJson(TableIWWebSiteSpAdver, " Enabled = 1 and iw_web_pages_part_id = '$iw_web_pages_part_id'  ", '*','id',1);
